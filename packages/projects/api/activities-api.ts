...
// @ts-ignore
import type { ActivityCursorResults } from '../model';
// @ts-ignore
...
export const ActivitiesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createActivity: async (activity?: Activity, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getActivityById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getActivityById', 'number', number)
            const localVarPath = `/activities/{number}`
         ...
         * @throws {RequiredError}
         */
        getAllActivities: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/activities`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getAllowedActivities: async (employeeNumber: number, projectNumber: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'employeeNumber' is not null or undefined
            assertParamExists('getAllowedActivities', 'employeeNumber', employeeNumber)
            // verify required parameter 'projectNumber' is not null or undefined
            assertParamExists('getAllowedActivities', 'projectNumber', projectNumber)
            const localVarPath = `/activities/allowed`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getNumberOfActivities: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/activities/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfActivities: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/activities/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        updateActivity: async (activity?: Activity, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/activities`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ActivitiesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createActivity(activity?: Activity, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createActivity(activity, options);
         ...
         * @throws {RequiredError}
         */
        async getActivityById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Activity>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getActivityById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getAllActivities(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ActivityCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllActivities(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ActivitiesApi.getAllActivities']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to get all the activities that the employee is allowed to register an entry on for a given project. Potential restrictions of registration are based on recording rules in the UI, which cannot be modified through the API. Add the employee number and project to your query parameter to obtain the allowed activities for registrations.
         ...
         * @throws {RequiredError}
         */
        async getAllowedActivities(employeeNumber: number, projectNumber: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Activity>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllowedActivities(employeeNumber, projectNumber, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ActivitiesApi.getAllowedActivities']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Activities. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfActivities(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfActivities(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ActivitiesApi.getNumberOfActivities']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Activities.
         ...
         * @throws {RequiredError}
         */
        async getPageOfActivities(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Activity>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfActivities(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ActivitiesApi.getPageOfActivities']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to update a single Activity.
         ...
         * @throws {RequiredError}
         */
        async updateActivity(activity?: Activity, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateActivity(activity, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ActivitiesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Use this endpoint to create a single Activity.
         * @summary Create a single Activity
         * @param {ActivitiesApiCreateActivityRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createActivity(requestParameters: ActivitiesApiCreateActivityRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CreatedResult> {
            return localVarFp.createActivity(requestParameters.activity, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Activity by id/number.
         * @summary Retrieve single Activity
         * @param {ActivitiesApiGetActivityByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getActivityById(requestParameters: ActivitiesApiGetActivityByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<Activity> {
            return localVarFp.getActivityById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all Activities in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Activities
         * @param {ActivitiesApiGetAllActivitiesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllActivities(requestParameters: ActivitiesApiGetAllActivitiesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ActivityCursorResults> {
            return localVarFp.getAllActivities(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to get all the activities that the employee is allowed to register an entry on for a given project. Potential restrictions of registration are based on recording rules in the UI, which cannot be modified through the API. Add the employee number and project to your query parameter to obtain the allowed activities for registrations.
         * @summary Retrieve allowed activities
         * @param {ActivitiesApiGetAllowedActivitiesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllowedActivities(requestParameters: ActivitiesApiGetAllowedActivitiesRequest, options?: RawAxiosRequestConfig): AxiosPromise<Array<Activity>> {
            return localVarFp.getAllowedActivities(requestParameters.employeeNumber, requestParameters.projectNumber, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Activities. You can use a filtering as well.
         * @summary Retrieve the number of Activities
         * @param {ActivitiesApiGetNumberOfActivitiesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfActivities(requestParameters: ActivitiesApiGetNumberOfActivitiesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfActivities(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Activities.
         * @summary Retrieve a page of Activities
         * @param {ActivitiesApiGetPageOfActivitiesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfActivities(requestParameters: ActivitiesApiGetPageOfActivitiesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<Activity>> {
            return localVarFp.getPageOfActivities(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to update a single Activity.
         * @summary Update a single Activity
         ...
         * @throws {RequiredError}
         */
        updateActivity(requestParameters: ActivitiesApiUpdateActivityRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.updateActivity(requestParameters.activity, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createActivity operation in ActivitiesApi.
 * @export
 * @interface ActivitiesApiCreateActivityRequest
 */
export interface ActivitiesApiCreateActivityRequest {
    /**
     * 
     * @type {Activity}
     * @memberof ActivitiesApiCreateActivity
     */
    readonly activity?: Activity
}

/**
 * Request parameters for getActivityById operation in ActivitiesApi.
 * @export
 * @interface ActivitiesApiGetActivityByIdRequest
 */
export interface ActivitiesApiGetActivityByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ActivitiesApiGetActivityById
     */
    readonly number: number
}

/**
 * Request parameters for getAllActivities operation in ActivitiesApi.
 * @export
 * @interface ActivitiesApiGetAllActivitiesRequest
 */
export interface ActivitiesApiGetAllActivitiesRequest {
    /**
     * 
     * @type {string}
     * @memberof ActivitiesApiGetAllActivities
     */
...
/**
 * Request parameters for getAllowedActivities operation in ActivitiesApi.
 * @export
 * @interface ActivitiesApiGetAllowedActivitiesRequest
 */
export interface ActivitiesApiGetAllowedActivitiesRequest {
    /**
     * The employee number.
     * @type {number}
     * @memberof ActivitiesApiGetAllowedActivities
     */
...
/**
 * Request parameters for getNumberOfActivities operation in ActivitiesApi.
 * @export
 * @interface ActivitiesApiGetNumberOfActivitiesRequest
 */
export interface ActivitiesApiGetNumberOfActivitiesRequest {
    /**
     * 
     * @type {string}
     * @memberof ActivitiesApiGetNumberOfActivities
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfActivities operation in ActivitiesApi.
 * @export
 * @interface ActivitiesApiGetPageOfActivitiesRequest
 */
export interface ActivitiesApiGetPageOfActivitiesRequest {
    /**
     * 
     * @type {string}
     * @memberof ActivitiesApiGetPageOfActivities
     */
    readonly filter?: string
...
export class ActivitiesApi extends BaseAPI {
     ...
     */
    public createActivity(requestParameters: ActivitiesApiCreateActivityRequest = {}, options?: RawAxiosRequestConfig) {
        return ActivitiesApiFp(this.configuration).createActivity(requestParameters.activity, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivitiesApi
     */
    public getActivityById(requestParameters: ActivitiesApiGetActivityByIdRequest, options?: RawAxiosRequestConfig) {
        return ActivitiesApiFp(this.configuration).getActivityById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivitiesApi
     */
    public getAllActivities(requestParameters: ActivitiesApiGetAllActivitiesRequest = {}, options?: RawAxiosRequestConfig) {
        return ActivitiesApiFp(this.configuration).getAllActivities(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivitiesApi
     */
    public getAllowedActivities(requestParameters: ActivitiesApiGetAllowedActivitiesRequest, options?: RawAxiosRequestConfig) {
        return ActivitiesApiFp(this.configuration).getAllowedActivities(requestParameters.employeeNumber, requestParameters.projectNumber, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivitiesApi
     */
    public getNumberOfActivities(requestParameters: ActivitiesApiGetNumberOfActivitiesRequest = {}, options?: RawAxiosRequestConfig) {
        return ActivitiesApiFp(this.configuration).getNumberOfActivities(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivitiesApi
     */
    public getPageOfActivities(requestParameters: ActivitiesApiGetPageOfActivitiesRequest = {}, options?: RawAxiosRequestConfig) {
        return ActivitiesApiFp(this.configuration).getPageOfActivities(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivitiesApi
     */
    public updateActivity(requestParameters: ActivitiesApiUpdateActivityRequest = {}, options?: RawAxiosRequestConfig) {
        return ActivitiesApiFp(this.configuration).updateActivity(requestParameters.activity, options).then((request) => request(this.axios, this.basePath));
    }
}
