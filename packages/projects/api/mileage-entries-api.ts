...
// @ts-ignore
import type { Mileage } from '../model';
// @ts-ignore
import type { MileageCursorResults } from '../model';
// @ts-ignore
import type { MileageNumbersCollection } from '../model';
/**
 * MileageEntriesApi - axios parameter creator
 * @export
 */
export const MileageEntriesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Use this endpoint to approve a list of Mileage entries.
         * @summary Approve a list of Mileage entries
         * @param {MileageNumbersCollection} [mileageNumbersCollection] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        approveMileageEntries: async (mileageNumbersCollection?: MileageNumbersCollection, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mileages/approve`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(mileageNumbersCollection, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        createMileage: async (mileage?: Mileage, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mileages`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(mileage, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        deleteMileageById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('deleteMileageById', 'number', number)
            const localVarPath = `/mileages/{number}`
         ...
         * @throws {RequiredError}
         */
        getAllMileageEntries: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mileages`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getMileageById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getMileageById', 'number', number)
            const localVarPath = `/mileages/{number}`
                .replace(`{${"number"}}`, encodeURIComponent(String(number)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        getNumberOfMileageEntries: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mileages/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfMileageEntries: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mileages/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        updateMileage: async (mileage?: Mileage, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mileages`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
/**
 * MileageEntriesApi - functional programming interface
 * @export
 */
export const MileageEntriesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = MileageEntriesApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to approve a list of Mileage entries.
         * @summary Approve a list of Mileage entries
         ...
         * @throws {RequiredError}
         */
        async approveMileageEntries(mileageNumbersCollection?: MileageNumbersCollection, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.approveMileageEntries(mileageNumbersCollection, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntriesApi.approveMileageEntries']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async createMileage(mileage?: Mileage, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createMileage(mileage, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntriesApi.createMileage']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to delete a single Mileage entry by id/number.
         ...
         * @throws {RequiredError}
         */
        async deleteMileageById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteMileageById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntriesApi.deleteMileageById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to retrieve all Mileage entries in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         ...
         * @throws {RequiredError}
         */
        async getAllMileageEntries(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MileageCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllMileageEntries(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntriesApi.getAllMileageEntries']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Mileage entry by id/number.
         ...
         * @throws {RequiredError}
         */
        async getMileageById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Mileage>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMileageById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntriesApi.getMileageById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Mileage entries. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfMileageEntries(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfMileageEntries(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntriesApi.getNumberOfMileageEntries']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Mileage entries.
         ...
         * @throws {RequiredError}
         */
        async getPageOfMileageEntries(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Mileage>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfMileageEntries(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntriesApi.getPageOfMileageEntries']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to update a single Mileage entry.
         ...
         * @throws {RequiredError}
         */
        async updateMileage(mileage?: Mileage, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateMileage(mileage, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntriesApi.updateMileage']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * MileageEntriesApi - factory interface
 * @export
 */
export const MileageEntriesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = MileageEntriesApiFp(configuration)
    return {
        /**
         * Use this endpoint to approve a list of Mileage entries.
         * @summary Approve a list of Mileage entries
         * @param {MileageEntriesApiApproveMileageEntriesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        approveMileageEntries(requestParameters: MileageEntriesApiApproveMileageEntriesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.approveMileageEntries(requestParameters.mileageNumbersCollection, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to create a single Mileage entry.
         * @summary Create a single Mileage entry
         * @param {MileageEntriesApiCreateMileageRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createMileage(requestParameters: MileageEntriesApiCreateMileageRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CreatedResult> {
            return localVarFp.createMileage(requestParameters.mileage, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to delete a single Mileage entry by id/number.
         * @summary Delete single Mileage entry
         * @param {MileageEntriesApiDeleteMileageByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteMileageById(requestParameters: MileageEntriesApiDeleteMileageByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteMileageById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all Mileage entries in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Mileage entries
         * @param {MileageEntriesApiGetAllMileageEntriesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllMileageEntries(requestParameters: MileageEntriesApiGetAllMileageEntriesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<MileageCursorResults> {
            return localVarFp.getAllMileageEntries(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Mileage entry by id/number.
         * @summary Retrieve single Mileage entry
         * @param {MileageEntriesApiGetMileageByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getMileageById(requestParameters: MileageEntriesApiGetMileageByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<Mileage> {
            return localVarFp.getMileageById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Mileage entries. You can use a filtering as well.
         * @summary Retrieve the number of Mileage entries
         * @param {MileageEntriesApiGetNumberOfMileageEntriesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfMileageEntries(requestParameters: MileageEntriesApiGetNumberOfMileageEntriesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfMileageEntries(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Mileage entries.
         * @summary Retrieve a page of Mileage entries
         * @param {MileageEntriesApiGetPageOfMileageEntriesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfMileageEntries(requestParameters: MileageEntriesApiGetPageOfMileageEntriesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<Mileage>> {
            return localVarFp.getPageOfMileageEntries(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to update a single Mileage entry.
         * @summary Update a single Mileage entry
         * @param {MileageEntriesApiUpdateMileageRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateMileage(requestParameters: MileageEntriesApiUpdateMileageRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.updateMileage(requestParameters.mileage, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for approveMileageEntries operation in MileageEntriesApi.
 * @export
 * @interface MileageEntriesApiApproveMileageEntriesRequest
 */
export interface MileageEntriesApiApproveMileageEntriesRequest {
    /**
     * 
     * @type {MileageNumbersCollection}
     * @memberof MileageEntriesApiApproveMileageEntries
     */
    readonly mileageNumbersCollection?: MileageNumbersCollection
}

/**
 * Request parameters for createMileage operation in MileageEntriesApi.
 * @export
 * @interface MileageEntriesApiCreateMileageRequest
 */
export interface MileageEntriesApiCreateMileageRequest {
    /**
     * 
     * @type {Mileage}
     * @memberof MileageEntriesApiCreateMileage
     */
    readonly mileage?: Mileage
}

/**
 * Request parameters for deleteMileageById operation in MileageEntriesApi.
 * @export
 * @interface MileageEntriesApiDeleteMileageByIdRequest
 */
export interface MileageEntriesApiDeleteMileageByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof MileageEntriesApiDeleteMileageById
     */
    readonly number: number
}

/**
 * Request parameters for getAllMileageEntries operation in MileageEntriesApi.
 * @export
 * @interface MileageEntriesApiGetAllMileageEntriesRequest
 */
export interface MileageEntriesApiGetAllMileageEntriesRequest {
    /**
     * 
     * @type {string}
     * @memberof MileageEntriesApiGetAllMileageEntries
     */
...
/**
 * Request parameters for getMileageById operation in MileageEntriesApi.
 * @export
 * @interface MileageEntriesApiGetMileageByIdRequest
 */
export interface MileageEntriesApiGetMileageByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof MileageEntriesApiGetMileageById
     */
    readonly number: number
}

/**
 * Request parameters for getNumberOfMileageEntries operation in MileageEntriesApi.
 * @export
 * @interface MileageEntriesApiGetNumberOfMileageEntriesRequest
 */
export interface MileageEntriesApiGetNumberOfMileageEntriesRequest {
    /**
     * 
     * @type {string}
     * @memberof MileageEntriesApiGetNumberOfMileageEntries
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfMileageEntries operation in MileageEntriesApi.
 * @export
 * @interface MileageEntriesApiGetPageOfMileageEntriesRequest
 */
export interface MileageEntriesApiGetPageOfMileageEntriesRequest {
    /**
     * 
     * @type {string}
     * @memberof MileageEntriesApiGetPageOfMileageEntries
     */
    readonly filter?: string
...
/**
 * Request parameters for updateMileage operation in MileageEntriesApi.
 * @export
 * @interface MileageEntriesApiUpdateMileageRequest
 */
export interface MileageEntriesApiUpdateMileageRequest {
    /**
     * 
     * @type {Mileage}
     * @memberof MileageEntriesApiUpdateMileage
     */
    readonly mileage?: Mileage
}

/**
 * MileageEntriesApi - object-oriented interface
 * @export
 * @class MileageEntriesApi
 * @extends {BaseAPI}
 */
export class MileageEntriesApi extends BaseAPI {
    /**
     * Use this endpoint to approve a list of Mileage entries.
     * @summary Approve a list of Mileage entries
     * @param {MileageEntriesApiApproveMileageEntriesRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof MileageEntriesApi
     */
    public approveMileageEntries(requestParameters: MileageEntriesApiApproveMileageEntriesRequest = {}, options?: RawAxiosRequestConfig) {
        return MileageEntriesApiFp(this.configuration).approveMileageEntries(requestParameters.mileageNumbersCollection, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MileageEntriesApi
     */
    public createMileage(requestParameters: MileageEntriesApiCreateMileageRequest = {}, options?: RawAxiosRequestConfig) {
        return MileageEntriesApiFp(this.configuration).createMileage(requestParameters.mileage, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MileageEntriesApi
     */
    public deleteMileageById(requestParameters: MileageEntriesApiDeleteMileageByIdRequest, options?: RawAxiosRequestConfig) {
        return MileageEntriesApiFp(this.configuration).deleteMileageById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MileageEntriesApi
     */
    public getAllMileageEntries(requestParameters: MileageEntriesApiGetAllMileageEntriesRequest = {}, options?: RawAxiosRequestConfig) {
        return MileageEntriesApiFp(this.configuration).getAllMileageEntries(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MileageEntriesApi
     */
    public getMileageById(requestParameters: MileageEntriesApiGetMileageByIdRequest, options?: RawAxiosRequestConfig) {
        return MileageEntriesApiFp(this.configuration).getMileageById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MileageEntriesApi
     */
    public getNumberOfMileageEntries(requestParameters: MileageEntriesApiGetNumberOfMileageEntriesRequest = {}, options?: RawAxiosRequestConfig) {
        return MileageEntriesApiFp(this.configuration).getNumberOfMileageEntries(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MileageEntriesApi
     */
    public getPageOfMileageEntries(requestParameters: MileageEntriesApiGetPageOfMileageEntriesRequest = {}, options?: RawAxiosRequestConfig) {
        return MileageEntriesApiFp(this.configuration).getPageOfMileageEntries(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MileageEntriesApi
     */
    public updateMileage(requestParameters: MileageEntriesApiUpdateMileageRequest = {}, options?: RawAxiosRequestConfig) {
        return MileageEntriesApiFp(this.configuration).updateMileage(requestParameters.mileage, options).then((request) => request(this.axios, this.basePath));
    }
}
