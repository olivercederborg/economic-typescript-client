...
// @ts-ignore
import type { ProjectCustomer } from '../model';
// @ts-ignore
import type { ProjectCustomerCursorResults } from '../model';
/**
 * ProjectCustomersApi - axios parameter creator
 * @export
 */
export const ProjectCustomersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getAllProjectCustomers: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-customers`;
         ...
         * @throws {RequiredError}
         */
        getNumberOfProjectCustomers: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-customers/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfProjectCustomers: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-customers/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getProjectCustomerById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getProjectCustomerById', 'number', number)
            const localVarPath = `/project-customers/{number}`
...
/**
 * ProjectCustomersApi - functional programming interface
 * @export
 */
export const ProjectCustomersApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ProjectCustomersApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to retrieve all Project Customers in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Project Customers
         ...
         * @throws {RequiredError}
         */
        async getAllProjectCustomers(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectCustomerCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllProjectCustomers(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectCustomersApi.getAllProjectCustomers']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getNumberOfProjectCustomers(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfProjectCustomers(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectCustomersApi.getNumberOfProjectCustomers']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Project Customers.
         ...
         * @throws {RequiredError}
         */
        async getPageOfProjectCustomers(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProjectCustomer>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfProjectCustomers(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectCustomersApi.getPageOfProjectCustomers']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Project Customer by id/number.
         ...
         * @throws {RequiredError}
         */
        async getProjectCustomerById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectCustomer>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProjectCustomerById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectCustomersApi.getProjectCustomerById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * ProjectCustomersApi - factory interface
 * @export
 */
export const ProjectCustomersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ProjectCustomersApiFp(configuration)
    return {
        /**
         * Use this endpoint to retrieve all Project Customers in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Project Customers
         * @param {ProjectCustomersApiGetAllProjectCustomersRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllProjectCustomers(requestParameters: ProjectCustomersApiGetAllProjectCustomersRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ProjectCustomerCursorResults> {
            return localVarFp.getAllProjectCustomers(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Project Customers. You can use a filtering as well.
         * @summary Retrieve the number of Project Customers
         * @param {ProjectCustomersApiGetNumberOfProjectCustomersRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfProjectCustomers(requestParameters: ProjectCustomersApiGetNumberOfProjectCustomersRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfProjectCustomers(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Project Customers.
         * @summary Retrieve a page of Project Customers
         * @param {ProjectCustomersApiGetPageOfProjectCustomersRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfProjectCustomers(requestParameters: ProjectCustomersApiGetPageOfProjectCustomersRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<ProjectCustomer>> {
            return localVarFp.getPageOfProjectCustomers(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Project Customer by id/number.
         * @summary Retrieve single Project Customer
         * @param {ProjectCustomersApiGetProjectCustomerByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getProjectCustomerById(requestParameters: ProjectCustomersApiGetProjectCustomerByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProjectCustomer> {
            return localVarFp.getProjectCustomerById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getAllProjectCustomers operation in ProjectCustomersApi.
 * @export
 * @interface ProjectCustomersApiGetAllProjectCustomersRequest
 */
export interface ProjectCustomersApiGetAllProjectCustomersRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectCustomersApiGetAllProjectCustomers
     */
...
/**
 * Request parameters for getNumberOfProjectCustomers operation in ProjectCustomersApi.
 * @export
 * @interface ProjectCustomersApiGetNumberOfProjectCustomersRequest
 */
export interface ProjectCustomersApiGetNumberOfProjectCustomersRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectCustomersApiGetNumberOfProjectCustomers
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfProjectCustomers operation in ProjectCustomersApi.
 * @export
 * @interface ProjectCustomersApiGetPageOfProjectCustomersRequest
 */
export interface ProjectCustomersApiGetPageOfProjectCustomersRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectCustomersApiGetPageOfProjectCustomers
     */
    readonly filter?: string
...
/**
 * Request parameters for getProjectCustomerById operation in ProjectCustomersApi.
 * @export
 * @interface ProjectCustomersApiGetProjectCustomerByIdRequest
 */
export interface ProjectCustomersApiGetProjectCustomerByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ProjectCustomersApiGetProjectCustomerById
     */
    readonly number: number
}

/**
 * ProjectCustomersApi - object-oriented interface
 * @export
 * @class ProjectCustomersApi
 * @extends {BaseAPI}
 */
export class ProjectCustomersApi extends BaseAPI {
    /**
     * Use this endpoint to retrieve all Project Customers in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @summary Retrieve all Project Customers
     * @param {ProjectCustomersApiGetAllProjectCustomersRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ProjectCustomersApi
     */
    public getAllProjectCustomers(requestParameters: ProjectCustomersApiGetAllProjectCustomersRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectCustomersApiFp(this.configuration).getAllProjectCustomers(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectCustomersApi
     */
    public getNumberOfProjectCustomers(requestParameters: ProjectCustomersApiGetNumberOfProjectCustomersRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectCustomersApiFp(this.configuration).getNumberOfProjectCustomers(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectCustomersApi
     */
    public getPageOfProjectCustomers(requestParameters: ProjectCustomersApiGetPageOfProjectCustomersRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectCustomersApiFp(this.configuration).getPageOfProjectCustomers(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectCustomersApi
     */
    public getProjectCustomerById(requestParameters: ProjectCustomersApiGetProjectCustomerByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectCustomersApiFp(this.configuration).getProjectCustomerById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
}
