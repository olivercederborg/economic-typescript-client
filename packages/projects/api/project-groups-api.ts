...
// @ts-ignore
import type { ProjectGroup } from '../model';
// @ts-ignore
import type { ProjectGroupCursorResults } from '../model';
/**
 * ProjectGroupsApi - axios parameter creator
 * @export
 */
export const ProjectGroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        createProjectGroup: async (projectGroup?: ProjectGroup, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(projectGroup, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getAllProjectGroups: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/projectgroups`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getNumberOfProjectGroups: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/projectgroups/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfProjectGroups: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/projectgroups/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getProjectGroupById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getProjectGroupById', 'number', number)
            const localVarPath = `/projectgroups/{number}`
...
export const ProjectGroupsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ProjectGroupsApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to create a single Project Group.
         * @summary Create a single Project Group
         ...
         * @throws {RequiredError}
         */
        async createProjectGroup(projectGroup?: ProjectGroup, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createProjectGroup(projectGroup, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectGroupsApi.createProjectGroup']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getAllProjectGroups(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectGroupCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllProjectGroups(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectGroupsApi.getAllProjectGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Project Groups. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfProjectGroups(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfProjectGroups(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectGroupsApi.getNumberOfProjectGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Project Groups.
         ...
         * @throws {RequiredError}
         */
        async getPageOfProjectGroups(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProjectGroup>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfProjectGroups(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectGroupsApi.getPageOfProjectGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Project Group by id/number.
         ...
         * @throws {RequiredError}
         */
        async getProjectGroupById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectGroup>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProjectGroupById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectGroupsApi.getProjectGroupById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
 ...
 * @export
 */
export const ProjectGroupsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ProjectGroupsApiFp(configuration)
    return {
        /**
         * Use this endpoint to create a single Project Group.
         * @summary Create a single Project Group
         * @param {ProjectGroupsApiCreateProjectGroupRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createProjectGroup(requestParameters: ProjectGroupsApiCreateProjectGroupRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CreatedResult> {
            return localVarFp.createProjectGroup(requestParameters.projectGroup, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all Project Groups in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Project Groups
         * @param {ProjectGroupsApiGetAllProjectGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllProjectGroups(requestParameters: ProjectGroupsApiGetAllProjectGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ProjectGroupCursorResults> {
            return localVarFp.getAllProjectGroups(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Project Groups. You can use a filtering as well.
         * @summary Retrieve the number of Project Groups
         * @param {ProjectGroupsApiGetNumberOfProjectGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfProjectGroups(requestParameters: ProjectGroupsApiGetNumberOfProjectGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfProjectGroups(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Project Groups.
         * @summary Retrieve a page of Project Groups
         * @param {ProjectGroupsApiGetPageOfProjectGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfProjectGroups(requestParameters: ProjectGroupsApiGetPageOfProjectGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<ProjectGroup>> {
            return localVarFp.getPageOfProjectGroups(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Project Group by id/number.
         * @summary Retrieve single Project Group
         * @param {ProjectGroupsApiGetProjectGroupByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getProjectGroupById(requestParameters: ProjectGroupsApiGetProjectGroupByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProjectGroup> {
            return localVarFp.getProjectGroupById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createProjectGroup operation in ProjectGroupsApi.
 * @export
 * @interface ProjectGroupsApiCreateProjectGroupRequest
 */
export interface ProjectGroupsApiCreateProjectGroupRequest {
    /**
     * 
     * @type {ProjectGroup}
     * @memberof ProjectGroupsApiCreateProjectGroup
     */
    readonly projectGroup?: ProjectGroup
}

/**
 * Request parameters for getAllProjectGroups operation in ProjectGroupsApi.
 * @export
 * @interface ProjectGroupsApiGetAllProjectGroupsRequest
 */
export interface ProjectGroupsApiGetAllProjectGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectGroupsApiGetAllProjectGroups
     */
...
/**
 * Request parameters for getNumberOfProjectGroups operation in ProjectGroupsApi.
 * @export
 * @interface ProjectGroupsApiGetNumberOfProjectGroupsRequest
 */
export interface ProjectGroupsApiGetNumberOfProjectGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectGroupsApiGetNumberOfProjectGroups
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfProjectGroups operation in ProjectGroupsApi.
 * @export
 * @interface ProjectGroupsApiGetPageOfProjectGroupsRequest
 */
export interface ProjectGroupsApiGetPageOfProjectGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectGroupsApiGetPageOfProjectGroups
     */
    readonly filter?: string
...
/**
 * Request parameters for getProjectGroupById operation in ProjectGroupsApi.
 * @export
 * @interface ProjectGroupsApiGetProjectGroupByIdRequest
 */
export interface ProjectGroupsApiGetProjectGroupByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ProjectGroupsApiGetProjectGroupById
     */
...
export class ProjectGroupsApi extends BaseAPI {
     ...
     */
    public createProjectGroup(requestParameters: ProjectGroupsApiCreateProjectGroupRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectGroupsApiFp(this.configuration).createProjectGroup(requestParameters.projectGroup, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectGroupsApi
     */
    public getAllProjectGroups(requestParameters: ProjectGroupsApiGetAllProjectGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectGroupsApiFp(this.configuration).getAllProjectGroups(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectGroupsApi
     */
    public getNumberOfProjectGroups(requestParameters: ProjectGroupsApiGetNumberOfProjectGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectGroupsApiFp(this.configuration).getNumberOfProjectGroups(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectGroupsApi
     */
    public getPageOfProjectGroups(requestParameters: ProjectGroupsApiGetPageOfProjectGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectGroupsApiFp(this.configuration).getPageOfProjectGroups(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectGroupsApi
     */
    public getProjectGroupById(requestParameters: ProjectGroupsApiGetProjectGroupByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectGroupsApiFp(this.configuration).getProjectGroupById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
}
