...
// @ts-ignore
import type { EmployeeCursorResults } from '../model';
/**
...
export const EmployeesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createEmployee: async (employee?: Employee, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        deleteEmployeeById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('deleteEmployeeById', 'number', number)
         ...
         * @throws {RequiredError}
         */
        getAllEmployees: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/employees`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getEmployeeById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getEmployeeById', 'number', number)
            const localVarPath = `/employees/{number}`
                .replace(`{${"number"}}`, encodeURIComponent(String(number)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        getNumberOfEmployees: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/employees/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfEmployees: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/employees/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        updateEmployee: async (employee?: Employee, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/employees`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const EmployeesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createEmployee(employee?: Employee, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedResult>> {
         ...
         * @throws {RequiredError}
         */
        async deleteEmployeeById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteEmployeeById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['EmployeesApi.deleteEmployeeById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to retrieve all Employees in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         ...
         * @throws {RequiredError}
         */
        async getAllEmployees(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EmployeeCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllEmployees(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['EmployeesApi.getAllEmployees']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Employee by id/number.
         ...
         * @throws {RequiredError}
         */
        async getEmployeeById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Employee>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getEmployeeById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['EmployeesApi.getEmployeeById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Employees. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfEmployees(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfEmployees(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['EmployeesApi.getNumberOfEmployees']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Employees.
         ...
         * @throws {RequiredError}
         */
        async getPageOfEmployees(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Employee>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfEmployees(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['EmployeesApi.getPageOfEmployees']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to update a single Employee.
         ...
         * @throws {RequiredError}
         */
        async updateEmployee(employee?: Employee, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateEmployee(employee, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const EmployeesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createEmployee(requestParameters: EmployeesApiCreateEmployeeRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CreatedResult> {
            return localVarFp.createEmployee(requestParameters.employee, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to delete a single Employee by id/number.
         * @summary Delete single Employee
         * @param {EmployeesApiDeleteEmployeeByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteEmployeeById(requestParameters: EmployeesApiDeleteEmployeeByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteEmployeeById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all Employees in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Employees
         * @param {EmployeesApiGetAllEmployeesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllEmployees(requestParameters: EmployeesApiGetAllEmployeesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<EmployeeCursorResults> {
            return localVarFp.getAllEmployees(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Employee by id/number.
         * @summary Retrieve single Employee
         ...
         * @throws {RequiredError}
         */
        getEmployeeById(requestParameters: EmployeesApiGetEmployeeByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<Employee> {
            return localVarFp.getEmployeeById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Employees. You can use a filtering as well.
         * @summary Retrieve the number of Employees
         * @param {EmployeesApiGetNumberOfEmployeesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfEmployees(requestParameters: EmployeesApiGetNumberOfEmployeesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfEmployees(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Employees.
         * @summary Retrieve a page of Employees
         * @param {EmployeesApiGetPageOfEmployeesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfEmployees(requestParameters: EmployeesApiGetPageOfEmployeesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<Employee>> {
            return localVarFp.getPageOfEmployees(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to update a single Employee.
         * @summary Update a single Employee
        ...
        updateEmployee(requestParameters: EmployeesApiUpdateEmployeeRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.updateEmployee(requestParameters.employee, options).then((request) => request(axios, basePath));
        },
    };
};
...
/**
 * Request parameters for deleteEmployeeById operation in EmployeesApi.
 * @export
 * @interface EmployeesApiDeleteEmployeeByIdRequest
 */
export interface EmployeesApiDeleteEmployeeByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof EmployeesApiDeleteEmployeeById
     */
    readonly number: number
}

/**
 * Request parameters for getAllEmployees operation in EmployeesApi.
 * @export
 * @interface EmployeesApiGetAllEmployeesRequest
 */
export interface EmployeesApiGetAllEmployeesRequest {
    /**
     * 
     * @type {string}
     * @memberof EmployeesApiGetAllEmployees
     */
...
/**
 * Request parameters for getNumberOfEmployees operation in EmployeesApi.
 * @export
 * @interface EmployeesApiGetNumberOfEmployeesRequest
 */
export interface EmployeesApiGetNumberOfEmployeesRequest {
    /**
     * 
     * @type {string}
     * @memberof EmployeesApiGetNumberOfEmployees
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfEmployees operation in EmployeesApi.
 * @export
 * @interface EmployeesApiGetPageOfEmployeesRequest
 */
export interface EmployeesApiGetPageOfEmployeesRequest {
    /**
     * 
     * @type {string}
     * @memberof EmployeesApiGetPageOfEmployees
     */
    readonly filter?: string
...
export class EmployeesApi extends BaseAPI {
    ...
    public createEmployee(requestParameters: EmployeesApiCreateEmployeeRequest = {}, options?: RawAxiosRequestConfig) {
        return EmployeesApiFp(this.configuration).createEmployee(requestParameters.employee, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeesApi
     */
    public deleteEmployeeById(requestParameters: EmployeesApiDeleteEmployeeByIdRequest, options?: RawAxiosRequestConfig) {
        return EmployeesApiFp(this.configuration).deleteEmployeeById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeesApi
     */
    public getAllEmployees(requestParameters: EmployeesApiGetAllEmployeesRequest = {}, options?: RawAxiosRequestConfig) {
        return EmployeesApiFp(this.configuration).getAllEmployees(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeesApi
     */
    public getEmployeeById(requestParameters: EmployeesApiGetEmployeeByIdRequest, options?: RawAxiosRequestConfig) {
        return EmployeesApiFp(this.configuration).getEmployeeById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeesApi
     */
    public getNumberOfEmployees(requestParameters: EmployeesApiGetNumberOfEmployeesRequest = {}, options?: RawAxiosRequestConfig) {
        return EmployeesApiFp(this.configuration).getNumberOfEmployees(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeesApi
     */
    public getPageOfEmployees(requestParameters: EmployeesApiGetPageOfEmployeesRequest = {}, options?: RawAxiosRequestConfig) {
        return EmployeesApiFp(this.configuration).getPageOfEmployees(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateEmployee(requestParameters: EmployeesApiUpdateEmployeeRequest = {}, options?: RawAxiosRequestConfig) {
        return EmployeesApiFp(this.configuration).updateEmployee(requestParameters.employee, options).then((request) => request(this.axios, this.basePath));
    }
}
