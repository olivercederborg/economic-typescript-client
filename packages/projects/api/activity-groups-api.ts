...
// @ts-ignore
import type { ActivityGroup } from '../model';
// @ts-ignore
import type { ActivityGroupCursorResults } from '../model';
// @ts-ignore
import type { CreatedResult } from '../model';
/**
 * ActivityGroupsApi - axios parameter creator
 * @export
 */
export const ActivityGroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        createActivityGroup: async (activityGroup?: ActivityGroup, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/activitygroups`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(activityGroup, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getActivityGroupById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getActivityGroupById', 'number', number)
            const localVarPath = `/activitygroups/{number}`
         ...
         * @throws {RequiredError}
         */
        getAllActivityGroups: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/activitygroups`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getNumberOfActivityGroups: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/activitygroups/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfActivityGroups: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/activitygroups/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
/**
 * ActivityGroupsApi - functional programming interface
 * @export
 */
export const ActivityGroupsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ActivityGroupsApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to create a single Activity Group.
         * @summary Create a single Activity Group
         ...
         * @throws {RequiredError}
         */
        async createActivityGroup(activityGroup?: ActivityGroup, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createActivityGroup(activityGroup, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ActivityGroupsApi.createActivityGroup']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getActivityGroupById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ActivityGroup>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getActivityGroupById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ActivityGroupsApi.getActivityGroupById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to retrieve all Activity Groups in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         ...
         * @throws {RequiredError}
         */
        async getAllActivityGroups(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ActivityGroupCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllActivityGroups(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ActivityGroupsApi.getAllActivityGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Activity Groups. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfActivityGroups(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfActivityGroups(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ActivityGroupsApi.getNumberOfActivityGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Activity Groups.
         ...
         * @throws {RequiredError}
         */
        async getPageOfActivityGroups(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ActivityGroup>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfActivityGroups(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ActivityGroupsApi.getPageOfActivityGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * ActivityGroupsApi - factory interface
 * @export
 */
export const ActivityGroupsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ActivityGroupsApiFp(configuration)
    return {
        /**
         * Use this endpoint to create a single Activity Group.
         * @summary Create a single Activity Group
         * @param {ActivityGroupsApiCreateActivityGroupRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createActivityGroup(requestParameters: ActivityGroupsApiCreateActivityGroupRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CreatedResult> {
            return localVarFp.createActivityGroup(requestParameters.activityGroup, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Activity Group by id/number.
         * @summary Retrieve single Activity Group
         * @param {ActivityGroupsApiGetActivityGroupByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getActivityGroupById(requestParameters: ActivityGroupsApiGetActivityGroupByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<ActivityGroup> {
            return localVarFp.getActivityGroupById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all Activity Groups in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Activity Groups
         * @param {ActivityGroupsApiGetAllActivityGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllActivityGroups(requestParameters: ActivityGroupsApiGetAllActivityGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ActivityGroupCursorResults> {
            return localVarFp.getAllActivityGroups(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Activity Groups. You can use a filtering as well.
         * @summary Retrieve the number of Activity Groups
         * @param {ActivityGroupsApiGetNumberOfActivityGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfActivityGroups(requestParameters: ActivityGroupsApiGetNumberOfActivityGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfActivityGroups(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Activity Groups.
         * @summary Retrieve a page of Activity Groups
         * @param {ActivityGroupsApiGetPageOfActivityGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfActivityGroups(requestParameters: ActivityGroupsApiGetPageOfActivityGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<ActivityGroup>> {
            return localVarFp.getPageOfActivityGroups(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createActivityGroup operation in ActivityGroupsApi.
 * @export
 * @interface ActivityGroupsApiCreateActivityGroupRequest
 */
export interface ActivityGroupsApiCreateActivityGroupRequest {
    /**
     * 
     * @type {ActivityGroup}
     * @memberof ActivityGroupsApiCreateActivityGroup
     */
    readonly activityGroup?: ActivityGroup
}

/**
 * Request parameters for getActivityGroupById operation in ActivityGroupsApi.
 * @export
 * @interface ActivityGroupsApiGetActivityGroupByIdRequest
 */
export interface ActivityGroupsApiGetActivityGroupByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ActivityGroupsApiGetActivityGroupById
     */
    readonly number: number
}

/**
 * Request parameters for getAllActivityGroups operation in ActivityGroupsApi.
 * @export
 * @interface ActivityGroupsApiGetAllActivityGroupsRequest
 */
export interface ActivityGroupsApiGetAllActivityGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof ActivityGroupsApiGetAllActivityGroups
     */
...
/**
 * Request parameters for getNumberOfActivityGroups operation in ActivityGroupsApi.
 * @export
 * @interface ActivityGroupsApiGetNumberOfActivityGroupsRequest
 */
export interface ActivityGroupsApiGetNumberOfActivityGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof ActivityGroupsApiGetNumberOfActivityGroups
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfActivityGroups operation in ActivityGroupsApi.
 * @export
 * @interface ActivityGroupsApiGetPageOfActivityGroupsRequest
 */
export interface ActivityGroupsApiGetPageOfActivityGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof ActivityGroupsApiGetPageOfActivityGroups
     */
    readonly filter?: string
...
/**
 * ActivityGroupsApi - object-oriented interface
 * @export
 * @class ActivityGroupsApi
 * @extends {BaseAPI}
 */
export class ActivityGroupsApi extends BaseAPI {
    /**
     * Use this endpoint to create a single Activity Group.
     * @summary Create a single Activity Group
     * @param {ActivityGroupsApiCreateActivityGroupRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ActivityGroupsApi
     */
    public createActivityGroup(requestParameters: ActivityGroupsApiCreateActivityGroupRequest = {}, options?: RawAxiosRequestConfig) {
        return ActivityGroupsApiFp(this.configuration).createActivityGroup(requestParameters.activityGroup, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivityGroupsApi
     */
    public getActivityGroupById(requestParameters: ActivityGroupsApiGetActivityGroupByIdRequest, options?: RawAxiosRequestConfig) {
        return ActivityGroupsApiFp(this.configuration).getActivityGroupById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivityGroupsApi
     */
    public getAllActivityGroups(requestParameters: ActivityGroupsApiGetAllActivityGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return ActivityGroupsApiFp(this.configuration).getAllActivityGroups(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivityGroupsApi
     */
    public getNumberOfActivityGroups(requestParameters: ActivityGroupsApiGetNumberOfActivityGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return ActivityGroupsApiFp(this.configuration).getNumberOfActivityGroups(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivityGroupsApi
     */
    public getPageOfActivityGroups(requestParameters: ActivityGroupsApiGetPageOfActivityGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return ActivityGroupsApiFp(this.configuration).getPageOfActivityGroups(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
}
