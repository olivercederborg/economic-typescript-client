...
// @ts-ignore
import type { ProjectEmployeeGroup } from '../model';
// @ts-ignore
import type { ProjectEmployeeGroupCursorResults } from '../model';
/**
 * ProjectEmployeeGroupsApi - axios parameter creator
 * @export
 */
export const ProjectEmployeeGroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Use this endpoint to create a single Project employee group.
         * @summary Create a single Project employee group
         * @param {ProjectEmployeeGroup} [projectEmployeeGroup] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createProjectEmployeeGroup: async (projectEmployeeGroup?: ProjectEmployeeGroup, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-employeegroups`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(projectEmployeeGroup, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        deleteProjectEmployeeGroupById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('deleteProjectEmployeeGroupById', 'number', number)
            const localVarPath = `/project-employeegroups/{number}`
         ...
         * @throws {RequiredError}
         */
        getAllProjectEmployeeGroups: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-employeegroups`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getNumberOfProjectEmployeeGroups: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-employeegroups/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfProjectEmployeeGroups: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-employeegroups/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getProjectEmployeeGroupById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getProjectEmployeeGroupById', 'number', number)
            const localVarPath = `/project-employeegroups/{number}`
                .replace(`{${"number"}}`, encodeURIComponent(String(number)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        updateProjectEmployeeGroup: async (projectEmployeeGroup?: ProjectEmployeeGroup, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-employeegroups`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
/**
 * ProjectEmployeeGroupsApi - functional programming interface
 * @export
 */
export const ProjectEmployeeGroupsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ProjectEmployeeGroupsApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to create a single Project employee group.
         * @summary Create a single Project employee group
         ...
         * @throws {RequiredError}
         */
        async createProjectEmployeeGroup(projectEmployeeGroup?: ProjectEmployeeGroup, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createProjectEmployeeGroup(projectEmployeeGroup, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeeGroupsApi.createProjectEmployeeGroup']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async deleteProjectEmployeeGroupById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteProjectEmployeeGroupById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeeGroupsApi.deleteProjectEmployeeGroupById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to retrieve all Project employee groups in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         ...
         * @throws {RequiredError}
         */
        async getAllProjectEmployeeGroups(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectEmployeeGroupCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllProjectEmployeeGroups(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeeGroupsApi.getAllProjectEmployeeGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Project employee groups. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfProjectEmployeeGroups(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfProjectEmployeeGroups(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeeGroupsApi.getNumberOfProjectEmployeeGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Project employee groups.
         ...
         * @throws {RequiredError}
         */
        async getPageOfProjectEmployeeGroups(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProjectEmployeeGroup>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfProjectEmployeeGroups(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeeGroupsApi.getPageOfProjectEmployeeGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Project employee group by id/number.
         ...
         * @throws {RequiredError}
         */
        async getProjectEmployeeGroupById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectEmployeeGroup>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProjectEmployeeGroupById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeeGroupsApi.getProjectEmployeeGroupById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to update a single Project employee group.
         ...
         * @throws {RequiredError}
         */
        async updateProjectEmployeeGroup(projectEmployeeGroup?: ProjectEmployeeGroup, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateProjectEmployeeGroup(projectEmployeeGroup, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeeGroupsApi.updateProjectEmployeeGroup']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * ProjectEmployeeGroupsApi - factory interface
 * @export
 */
export const ProjectEmployeeGroupsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ProjectEmployeeGroupsApiFp(configuration)
    return {
        /**
         * Use this endpoint to create a single Project employee group.
         * @summary Create a single Project employee group
         * @param {ProjectEmployeeGroupsApiCreateProjectEmployeeGroupRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createProjectEmployeeGroup(requestParameters: ProjectEmployeeGroupsApiCreateProjectEmployeeGroupRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CreatedResult> {
            return localVarFp.createProjectEmployeeGroup(requestParameters.projectEmployeeGroup, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to delete a single Project employee group by id/number.
         * @summary Delete single Project employee group
         * @param {ProjectEmployeeGroupsApiDeleteProjectEmployeeGroupByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteProjectEmployeeGroupById(requestParameters: ProjectEmployeeGroupsApiDeleteProjectEmployeeGroupByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteProjectEmployeeGroupById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all Project employee groups in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Project employee groups
         * @param {ProjectEmployeeGroupsApiGetAllProjectEmployeeGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllProjectEmployeeGroups(requestParameters: ProjectEmployeeGroupsApiGetAllProjectEmployeeGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ProjectEmployeeGroupCursorResults> {
            return localVarFp.getAllProjectEmployeeGroups(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Project employee groups. You can use a filtering as well.
         * @summary Retrieve the number of Project employee groups
         * @param {ProjectEmployeeGroupsApiGetNumberOfProjectEmployeeGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfProjectEmployeeGroups(requestParameters: ProjectEmployeeGroupsApiGetNumberOfProjectEmployeeGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfProjectEmployeeGroups(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Project employee groups.
         * @summary Retrieve a page of Project employee groups
         * @param {ProjectEmployeeGroupsApiGetPageOfProjectEmployeeGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfProjectEmployeeGroups(requestParameters: ProjectEmployeeGroupsApiGetPageOfProjectEmployeeGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<ProjectEmployeeGroup>> {
            return localVarFp.getPageOfProjectEmployeeGroups(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Project employee group by id/number.
         * @summary Retrieve single Project employee group
         * @param {ProjectEmployeeGroupsApiGetProjectEmployeeGroupByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getProjectEmployeeGroupById(requestParameters: ProjectEmployeeGroupsApiGetProjectEmployeeGroupByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProjectEmployeeGroup> {
            return localVarFp.getProjectEmployeeGroupById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to update a single Project employee group.
         * @summary Update a single Project employee group
         * @param {ProjectEmployeeGroupsApiUpdateProjectEmployeeGroupRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateProjectEmployeeGroup(requestParameters: ProjectEmployeeGroupsApiUpdateProjectEmployeeGroupRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.updateProjectEmployeeGroup(requestParameters.projectEmployeeGroup, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createProjectEmployeeGroup operation in ProjectEmployeeGroupsApi.
 * @export
 * @interface ProjectEmployeeGroupsApiCreateProjectEmployeeGroupRequest
 */
export interface ProjectEmployeeGroupsApiCreateProjectEmployeeGroupRequest {
    /**
     * 
     * @type {ProjectEmployeeGroup}
     * @memberof ProjectEmployeeGroupsApiCreateProjectEmployeeGroup
     */
    readonly projectEmployeeGroup?: ProjectEmployeeGroup
}

/**
 * Request parameters for deleteProjectEmployeeGroupById operation in ProjectEmployeeGroupsApi.
 * @export
 * @interface ProjectEmployeeGroupsApiDeleteProjectEmployeeGroupByIdRequest
 */
export interface ProjectEmployeeGroupsApiDeleteProjectEmployeeGroupByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ProjectEmployeeGroupsApiDeleteProjectEmployeeGroupById
     */
    readonly number: number
}

/**
 * Request parameters for getAllProjectEmployeeGroups operation in ProjectEmployeeGroupsApi.
 * @export
 * @interface ProjectEmployeeGroupsApiGetAllProjectEmployeeGroupsRequest
 */
export interface ProjectEmployeeGroupsApiGetAllProjectEmployeeGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectEmployeeGroupsApiGetAllProjectEmployeeGroups
     */
...
/**
 * Request parameters for getNumberOfProjectEmployeeGroups operation in ProjectEmployeeGroupsApi.
 * @export
 * @interface ProjectEmployeeGroupsApiGetNumberOfProjectEmployeeGroupsRequest
 */
export interface ProjectEmployeeGroupsApiGetNumberOfProjectEmployeeGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectEmployeeGroupsApiGetNumberOfProjectEmployeeGroups
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfProjectEmployeeGroups operation in ProjectEmployeeGroupsApi.
 * @export
 * @interface ProjectEmployeeGroupsApiGetPageOfProjectEmployeeGroupsRequest
 */
export interface ProjectEmployeeGroupsApiGetPageOfProjectEmployeeGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectEmployeeGroupsApiGetPageOfProjectEmployeeGroups
     */
    readonly filter?: string
...
/**
 * Request parameters for getProjectEmployeeGroupById operation in ProjectEmployeeGroupsApi.
 * @export
 * @interface ProjectEmployeeGroupsApiGetProjectEmployeeGroupByIdRequest
 */
export interface ProjectEmployeeGroupsApiGetProjectEmployeeGroupByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ProjectEmployeeGroupsApiGetProjectEmployeeGroupById
     */
    readonly number: number
}

/**
 * Request parameters for updateProjectEmployeeGroup operation in ProjectEmployeeGroupsApi.
 * @export
 * @interface ProjectEmployeeGroupsApiUpdateProjectEmployeeGroupRequest
 */
export interface ProjectEmployeeGroupsApiUpdateProjectEmployeeGroupRequest {
    /**
     * 
     * @type {ProjectEmployeeGroup}
     * @memberof ProjectEmployeeGroupsApiUpdateProjectEmployeeGroup
     */
    readonly projectEmployeeGroup?: ProjectEmployeeGroup
}

/**
 * ProjectEmployeeGroupsApi - object-oriented interface
 * @export
 * @class ProjectEmployeeGroupsApi
 * @extends {BaseAPI}
 */
export class ProjectEmployeeGroupsApi extends BaseAPI {
    /**
     * Use this endpoint to create a single Project employee group.
     * @summary Create a single Project employee group
     * @param {ProjectEmployeeGroupsApiCreateProjectEmployeeGroupRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ProjectEmployeeGroupsApi
     */
    public createProjectEmployeeGroup(requestParameters: ProjectEmployeeGroupsApiCreateProjectEmployeeGroupRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectEmployeeGroupsApiFp(this.configuration).createProjectEmployeeGroup(requestParameters.projectEmployeeGroup, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeeGroupsApi
     */
    public deleteProjectEmployeeGroupById(requestParameters: ProjectEmployeeGroupsApiDeleteProjectEmployeeGroupByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectEmployeeGroupsApiFp(this.configuration).deleteProjectEmployeeGroupById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeeGroupsApi
     */
    public getAllProjectEmployeeGroups(requestParameters: ProjectEmployeeGroupsApiGetAllProjectEmployeeGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectEmployeeGroupsApiFp(this.configuration).getAllProjectEmployeeGroups(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeeGroupsApi
     */
    public getNumberOfProjectEmployeeGroups(requestParameters: ProjectEmployeeGroupsApiGetNumberOfProjectEmployeeGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectEmployeeGroupsApiFp(this.configuration).getNumberOfProjectEmployeeGroups(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeeGroupsApi
     */
    public getPageOfProjectEmployeeGroups(requestParameters: ProjectEmployeeGroupsApiGetPageOfProjectEmployeeGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectEmployeeGroupsApiFp(this.configuration).getPageOfProjectEmployeeGroups(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeeGroupsApi
     */
    public getProjectEmployeeGroupById(requestParameters: ProjectEmployeeGroupsApiGetProjectEmployeeGroupByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectEmployeeGroupsApiFp(this.configuration).getProjectEmployeeGroupById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeeGroupsApi
     */
    public updateProjectEmployeeGroup(requestParameters: ProjectEmployeeGroupsApiUpdateProjectEmployeeGroupRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectEmployeeGroupsApiFp(this.configuration).updateProjectEmployeeGroup(requestParameters.projectEmployeeGroup, options).then((request) => request(this.axios, this.basePath));
    }
}
