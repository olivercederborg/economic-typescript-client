...
// @ts-ignore
import type { TimeEntryPrices } from '../model';
// @ts-ignore
import type { TimeEntryPricesCursorResults } from '../model';
/**
 * TimeEntryPricesApi - axios parameter creator
 * @export
 */
export const TimeEntryPricesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getAllTimeEntryPrices: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/timeentryprices`;
         ...
         * @throws {RequiredError}
         */
        getPageOfTimeEntryPrices: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/timeentryprices/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getTimeEntryPricesById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getTimeEntryPricesById', 'number', number)
            const localVarPath = `/timeentryprices/{number}`
...
/**
 * TimeEntryPricesApi - functional programming interface
 * @export
 */
export const TimeEntryPricesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = TimeEntryPricesApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to retrieve all Time entry prices in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Time entry prices
         ...
         * @throws {RequiredError}
         */
        async getAllTimeEntryPrices(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TimeEntryPricesCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllTimeEntryPrices(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntryPricesApi.getAllTimeEntryPrices']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getPageOfTimeEntryPrices(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TimeEntryPrices>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfTimeEntryPrices(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntryPricesApi.getPageOfTimeEntryPrices']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Time entry prices by id/number.
         ...
         * @throws {RequiredError}
         */
        async getTimeEntryPricesById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TimeEntryPrices>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTimeEntryPricesById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntryPricesApi.getTimeEntryPricesById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * TimeEntryPricesApi - factory interface
 * @export
 */
export const TimeEntryPricesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = TimeEntryPricesApiFp(configuration)
    return {
        /**
         * Use this endpoint to retrieve all Time entry prices in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Time entry prices
         * @param {TimeEntryPricesApiGetAllTimeEntryPricesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllTimeEntryPrices(requestParameters: TimeEntryPricesApiGetAllTimeEntryPricesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<TimeEntryPricesCursorResults> {
            return localVarFp.getAllTimeEntryPrices(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Time entry prices.
         * @summary Retrieve a page of Time entry prices
         * @param {TimeEntryPricesApiGetPageOfTimeEntryPricesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfTimeEntryPrices(requestParameters: TimeEntryPricesApiGetPageOfTimeEntryPricesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<TimeEntryPrices>> {
            return localVarFp.getPageOfTimeEntryPrices(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Time entry prices by id/number.
         * @summary Retrieve single Time entry prices
         * @param {TimeEntryPricesApiGetTimeEntryPricesByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getTimeEntryPricesById(requestParameters: TimeEntryPricesApiGetTimeEntryPricesByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<TimeEntryPrices> {
            return localVarFp.getTimeEntryPricesById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getAllTimeEntryPrices operation in TimeEntryPricesApi.
 * @export
 * @interface TimeEntryPricesApiGetAllTimeEntryPricesRequest
 */
export interface TimeEntryPricesApiGetAllTimeEntryPricesRequest {
    /**
     * 
     * @type {string}
     * @memberof TimeEntryPricesApiGetAllTimeEntryPrices
     */
...
/**
 * Request parameters for getPageOfTimeEntryPrices operation in TimeEntryPricesApi.
 * @export
 * @interface TimeEntryPricesApiGetPageOfTimeEntryPricesRequest
 */
export interface TimeEntryPricesApiGetPageOfTimeEntryPricesRequest {
    /**
     * 
     * @type {string}
     * @memberof TimeEntryPricesApiGetPageOfTimeEntryPrices
     */
    readonly filter?: string
...
/**
 * Request parameters for getTimeEntryPricesById operation in TimeEntryPricesApi.
 * @export
 * @interface TimeEntryPricesApiGetTimeEntryPricesByIdRequest
 */
export interface TimeEntryPricesApiGetTimeEntryPricesByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof TimeEntryPricesApiGetTimeEntryPricesById
     */
    readonly number: number
}

/**
 * TimeEntryPricesApi - object-oriented interface
 * @export
 * @class TimeEntryPricesApi
 * @extends {BaseAPI}
 */
export class TimeEntryPricesApi extends BaseAPI {
    /**
     * Use this endpoint to retrieve all Time entry prices in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @summary Retrieve all Time entry prices
     * @param {TimeEntryPricesApiGetAllTimeEntryPricesRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof TimeEntryPricesApi
     */
    public getAllTimeEntryPrices(requestParameters: TimeEntryPricesApiGetAllTimeEntryPricesRequest = {}, options?: RawAxiosRequestConfig) {
        return TimeEntryPricesApiFp(this.configuration).getAllTimeEntryPrices(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TimeEntryPricesApi
     */
    public getPageOfTimeEntryPrices(requestParameters: TimeEntryPricesApiGetPageOfTimeEntryPricesRequest = {}, options?: RawAxiosRequestConfig) {
        return TimeEntryPricesApiFp(this.configuration).getPageOfTimeEntryPrices(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TimeEntryPricesApi
     */
    public getTimeEntryPricesById(requestParameters: TimeEntryPricesApiGetTimeEntryPricesByIdRequest, options?: RawAxiosRequestConfig) {
        return TimeEntryPricesApiFp(this.configuration).getTimeEntryPricesById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
}
