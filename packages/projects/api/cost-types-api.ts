...
// @ts-ignore
import type { CostType } from '../model';
// @ts-ignore
import type { CostTypeCursorResults } from '../model';
/**
 * CostTypesApi - axios parameter creator
 * @export
 */
export const CostTypesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getAllCostTypes: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/costtypes`;
         ...
         * @throws {RequiredError}
         */
        getCostTypeById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getCostTypeById', 'number', number)
            const localVarPath = `/costtypes/{number}`
         ...
         * @throws {RequiredError}
         */
        getNumberOfCostTypes: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/costtypes/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfCostTypes: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/costtypes/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
/**
 * CostTypesApi - functional programming interface
 * @export
 */
export const CostTypesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = CostTypesApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to retrieve all Cost Types in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Cost Types
         ...
         * @throws {RequiredError}
         */
        async getAllCostTypes(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CostTypeCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllCostTypes(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CostTypesApi.getAllCostTypes']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getCostTypeById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CostType>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCostTypeById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CostTypesApi.getCostTypeById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Cost Types. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfCostTypes(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfCostTypes(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CostTypesApi.getNumberOfCostTypes']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Cost Types.
         ...
         * @throws {RequiredError}
         */
        async getPageOfCostTypes(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CostType>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfCostTypes(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CostTypesApi.getPageOfCostTypes']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * CostTypesApi - factory interface
 * @export
 */
export const CostTypesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = CostTypesApiFp(configuration)
    return {
        /**
         * Use this endpoint to retrieve all Cost Types in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Cost Types
         * @param {CostTypesApiGetAllCostTypesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllCostTypes(requestParameters: CostTypesApiGetAllCostTypesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CostTypeCursorResults> {
            return localVarFp.getAllCostTypes(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Cost Type by id/number.
         * @summary Retrieve single Cost Type
         * @param {CostTypesApiGetCostTypeByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getCostTypeById(requestParameters: CostTypesApiGetCostTypeByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<CostType> {
            return localVarFp.getCostTypeById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Cost Types. You can use a filtering as well.
         * @summary Retrieve the number of Cost Types
         * @param {CostTypesApiGetNumberOfCostTypesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfCostTypes(requestParameters: CostTypesApiGetNumberOfCostTypesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfCostTypes(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Cost Types.
         * @summary Retrieve a page of Cost Types
         * @param {CostTypesApiGetPageOfCostTypesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfCostTypes(requestParameters: CostTypesApiGetPageOfCostTypesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<CostType>> {
            return localVarFp.getPageOfCostTypes(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getAllCostTypes operation in CostTypesApi.
 * @export
 * @interface CostTypesApiGetAllCostTypesRequest
 */
export interface CostTypesApiGetAllCostTypesRequest {
    /**
     * 
     * @type {string}
     * @memberof CostTypesApiGetAllCostTypes
     */
...
/**
 * Request parameters for getCostTypeById operation in CostTypesApi.
 * @export
 * @interface CostTypesApiGetCostTypeByIdRequest
 */
export interface CostTypesApiGetCostTypeByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof CostTypesApiGetCostTypeById
     */
    readonly number: number
}

/**
 * Request parameters for getNumberOfCostTypes operation in CostTypesApi.
 * @export
 * @interface CostTypesApiGetNumberOfCostTypesRequest
 */
export interface CostTypesApiGetNumberOfCostTypesRequest {
    /**
     * 
     * @type {string}
     * @memberof CostTypesApiGetNumberOfCostTypes
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfCostTypes operation in CostTypesApi.
 * @export
 * @interface CostTypesApiGetPageOfCostTypesRequest
 */
export interface CostTypesApiGetPageOfCostTypesRequest {
    /**
     * 
     * @type {string}
     * @memberof CostTypesApiGetPageOfCostTypes
     */
    readonly filter?: string
...
/**
 * CostTypesApi - object-oriented interface
 * @export
 * @class CostTypesApi
 * @extends {BaseAPI}
 */
export class CostTypesApi extends BaseAPI {
    /**
     * Use this endpoint to retrieve all Cost Types in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @summary Retrieve all Cost Types
     * @param {CostTypesApiGetAllCostTypesRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CostTypesApi
     */
    public getAllCostTypes(requestParameters: CostTypesApiGetAllCostTypesRequest = {}, options?: RawAxiosRequestConfig) {
        return CostTypesApiFp(this.configuration).getAllCostTypes(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CostTypesApi
     */
    public getCostTypeById(requestParameters: CostTypesApiGetCostTypeByIdRequest, options?: RawAxiosRequestConfig) {
        return CostTypesApiFp(this.configuration).getCostTypeById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CostTypesApi
     */
    public getNumberOfCostTypes(requestParameters: CostTypesApiGetNumberOfCostTypesRequest = {}, options?: RawAxiosRequestConfig) {
        return CostTypesApiFp(this.configuration).getNumberOfCostTypes(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CostTypesApi
     */
    public getPageOfCostTypes(requestParameters: CostTypesApiGetPageOfCostTypesRequest = {}, options?: RawAxiosRequestConfig) {
        return CostTypesApiFp(this.configuration).getPageOfCostTypes(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
}
