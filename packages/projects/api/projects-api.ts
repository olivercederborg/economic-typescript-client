...
// @ts-ignore
import type { ProjectCursorResults } from '../model';
/**
...
export const ProjectsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteProjectById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('deleteProjectById', 'number', number)
            const localVarPath = `/projects/{number}`
         ...
         * @throws {RequiredError}
         */
        getAllProjects: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/projects`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getNumberOfProjects: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/projects/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfProjects: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/projects/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPagedListOfProjectUnderEmployee: async (employeeNumber: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'employeeNumber' is not null or undefined
            assertParamExists('getPagedListOfProjectUnderEmployee', 'employeeNumber', employeeNumber)
            const localVarPath = `/projects/allowed`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getProjectById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getProjectById', 'number', number)
            const localVarPath = `/projects/{number}`
                .replace(`{${"number"}}`, encodeURIComponent(String(number)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        updateProject: async (project?: Project, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/projects`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ProjectsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createProject(project?: Project, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedResult>> {
         ...
         * @throws {RequiredError}
         */
        async deleteProjectById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteProjectById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectsApi.deleteProjectById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to retrieve all Projects in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         ...
         * @throws {RequiredError}
         */
        async getAllProjects(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllProjects(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getNumberOfProjects(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfProjects(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectsApi.getNumberOfProjects']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Projects.
         ...
         * @throws {RequiredError}
         */
        async getPageOfProjects(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Project>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfProjects(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectsApi.getPageOfProjects']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to get all the projects that the employee is allowed to register an entry on. Potential restrictions of registration are based on recording rules in the UI, which cannot be modified through the API. Add the employee number to your query parameter to obtain the allowed projects for registrations.
         ...
         * @throws {RequiredError}
         */
        async getPagedListOfProjectUnderEmployee(employeeNumber: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Project>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPagedListOfProjectUnderEmployee(employeeNumber, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectsApi.getPagedListOfProjectUnderEmployee']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Project by id/number.
         ...
         * @throws {RequiredError}
         */
        async getProjectById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Project>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProjectById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async updateProject(project?: Project, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const ProjectsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createProject(requestParameters: ProjectsApiCreateProjectRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CreatedResult> {
         ...
         * @throws {RequiredError}
         */
        deleteProjectById(requestParameters: ProjectsApiDeleteProjectByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteProjectById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all Projects in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Projects
         ...
         * @throws {RequiredError}
         */
        getAllProjects(requestParameters: ProjectsApiGetAllProjectsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ProjectCursorResults> {
            return localVarFp.getAllProjects(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Projects. You can use a filtering as well.
         * @summary Retrieve the number of Projects
         * @param {ProjectsApiGetNumberOfProjectsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfProjects(requestParameters: ProjectsApiGetNumberOfProjectsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfProjects(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Projects.
         * @summary Retrieve a page of Projects
         * @param {ProjectsApiGetPageOfProjectsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfProjects(requestParameters: ProjectsApiGetPageOfProjectsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<Project>> {
            return localVarFp.getPageOfProjects(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to get all the projects that the employee is allowed to register an entry on. Potential restrictions of registration are based on recording rules in the UI, which cannot be modified through the API. Add the employee number to your query parameter to obtain the allowed projects for registrations.
         * @summary Retrieve the allowed projects that employee can register an entry on.
         * @param {ProjectsApiGetPagedListOfProjectUnderEmployeeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPagedListOfProjectUnderEmployee(requestParameters: ProjectsApiGetPagedListOfProjectUnderEmployeeRequest, options?: RawAxiosRequestConfig): AxiosPromise<Array<Project>> {
            return localVarFp.getPagedListOfProjectUnderEmployee(requestParameters.employeeNumber, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Project by id/number.
         * @summary Retrieve single Project
         ...
         * @throws {RequiredError}
         */
        getProjectById(requestParameters: ProjectsApiGetProjectByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<Project> {
            return localVarFp.getProjectById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to update a single Project.
         * @summary Update a single Project
         ...
         * @throws {RequiredError}
         */
        updateProject(requestParameters: ProjectsApiUpdateProjectRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.updateProject(requestParameters.project, options).then((request) => request(axios, basePath));
        },
    };
};
 ...
 */
export interface ProjectsApiDeleteProjectByIdRequest {
    /**
     * 
     * @type {number}
 ...
 */
export interface ProjectsApiGetAllProjectsRequest {
    /**
     * 
     * @type {string}
...
/**
 * Request parameters for getNumberOfProjects operation in ProjectsApi.
 * @export
 * @interface ProjectsApiGetNumberOfProjectsRequest
 */
export interface ProjectsApiGetNumberOfProjectsRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectsApiGetNumberOfProjects
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfProjects operation in ProjectsApi.
 * @export
 * @interface ProjectsApiGetPageOfProjectsRequest
 */
export interface ProjectsApiGetPageOfProjectsRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectsApiGetPageOfProjects
     */
    readonly filter?: string
...
/**
 * Request parameters for getPagedListOfProjectUnderEmployee operation in ProjectsApi.
 * @export
 * @interface ProjectsApiGetPagedListOfProjectUnderEmployeeRequest
 */
export interface ProjectsApiGetPagedListOfProjectUnderEmployeeRequest {
    /**
     * The employee number.
     * @type {number}
     * @memberof ProjectsApiGetPagedListOfProjectUnderEmployee
     */
...
export class ProjectsApi extends BaseAPI {
    ...
    public createProject(requestParameters: ProjectsApiCreateProjectRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectsApiFp(this.configuration).createProject(requestParameters.project, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectsApi
     */
    public deleteProjectById(requestParameters: ProjectsApiDeleteProjectByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectsApiFp(this.configuration).deleteProjectById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectsApi
     */
    public getAllProjects(requestParameters: ProjectsApiGetAllProjectsRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectsApiFp(this.configuration).getAllProjects(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectsApi
     */
    public getNumberOfProjects(requestParameters: ProjectsApiGetNumberOfProjectsRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectsApiFp(this.configuration).getNumberOfProjects(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectsApi
     */
    public getPageOfProjects(requestParameters: ProjectsApiGetPageOfProjectsRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectsApiFp(this.configuration).getPageOfProjects(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectsApi
     */
    public getPagedListOfProjectUnderEmployee(requestParameters: ProjectsApiGetPagedListOfProjectUnderEmployeeRequest, options?: RawAxiosRequestConfig) {
        return ProjectsApiFp(this.configuration).getPagedListOfProjectUnderEmployee(requestParameters.employeeNumber, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getProjectById(requestParameters: ProjectsApiGetProjectByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectsApiFp(this.configuration).getProjectById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateProject(requestParameters: ProjectsApiUpdateProjectRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectsApiFp(this.configuration).updateProject(requestParameters.project, options).then((request) => request(this.axios, this.basePath));
    }
}
