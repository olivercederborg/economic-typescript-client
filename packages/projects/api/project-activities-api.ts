...
// @ts-ignore
import type { ProjectActivity } from '../model';
// @ts-ignore
import type { ProjectActivityCursorResults } from '../model';
/**
 * ProjectActivitiesApi - axios parameter creator
 * @export
 */
export const ProjectActivitiesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        createProjectActivity: async (projectActivity?: ProjectActivity, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-activities`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(projectActivity, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        deleteProjectActivityById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('deleteProjectActivityById', 'number', number)
            const localVarPath = `/project-activities/{number}`
         ...
         * @throws {RequiredError}
         */
        getAllProjectActivities: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-activities`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getNumberOfProjectActivities: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-activities/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfProjectActivities: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-activities/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getProjectActivityById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getProjectActivityById', 'number', number)
            const localVarPath = `/project-activities/{number}`
                .replace(`{${"number"}}`, encodeURIComponent(String(number)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        updateProjectActivity: async (projectActivity?: ProjectActivity, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-activities`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
/**
 * ProjectActivitiesApi - functional programming interface
 * @export
 */
export const ProjectActivitiesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ProjectActivitiesApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to create a single Project Activity.
         * @summary Create a single Project Activity
         ...
         * @throws {RequiredError}
         */
        async createProjectActivity(projectActivity?: ProjectActivity, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createProjectActivity(projectActivity, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectActivitiesApi.createProjectActivity']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async deleteProjectActivityById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteProjectActivityById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectActivitiesApi.deleteProjectActivityById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to retrieve all Project Activities in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         ...
         * @throws {RequiredError}
         */
        async getAllProjectActivities(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectActivityCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllProjectActivities(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectActivitiesApi.getAllProjectActivities']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Project Activities. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfProjectActivities(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfProjectActivities(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectActivitiesApi.getNumberOfProjectActivities']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Project Activities.
         ...
         * @throws {RequiredError}
         */
        async getPageOfProjectActivities(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProjectActivity>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfProjectActivities(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectActivitiesApi.getPageOfProjectActivities']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Project Activity by id/number.
         ...
         * @throws {RequiredError}
         */
        async getProjectActivityById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectActivity>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProjectActivityById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectActivitiesApi.getProjectActivityById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to update a single Project Activity.
         ...
         * @throws {RequiredError}
         */
        async updateProjectActivity(projectActivity?: ProjectActivity, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateProjectActivity(projectActivity, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectActivitiesApi.updateProjectActivity']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * ProjectActivitiesApi - factory interface
 * @export
 */
export const ProjectActivitiesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ProjectActivitiesApiFp(configuration)
    return {
        /**
         * Use this endpoint to create a single Project Activity.
         * @summary Create a single Project Activity
         * @param {ProjectActivitiesApiCreateProjectActivityRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createProjectActivity(requestParameters: ProjectActivitiesApiCreateProjectActivityRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CreatedResult> {
            return localVarFp.createProjectActivity(requestParameters.projectActivity, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to delete a single Project Activity by id/number.
         * @summary Delete single Project Activity
         * @param {ProjectActivitiesApiDeleteProjectActivityByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteProjectActivityById(requestParameters: ProjectActivitiesApiDeleteProjectActivityByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteProjectActivityById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all Project Activities in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Project Activities
         * @param {ProjectActivitiesApiGetAllProjectActivitiesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllProjectActivities(requestParameters: ProjectActivitiesApiGetAllProjectActivitiesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ProjectActivityCursorResults> {
            return localVarFp.getAllProjectActivities(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Project Activities. You can use a filtering as well.
         * @summary Retrieve the number of Project Activities
         * @param {ProjectActivitiesApiGetNumberOfProjectActivitiesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfProjectActivities(requestParameters: ProjectActivitiesApiGetNumberOfProjectActivitiesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfProjectActivities(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Project Activities.
         * @summary Retrieve a page of Project Activities
         * @param {ProjectActivitiesApiGetPageOfProjectActivitiesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfProjectActivities(requestParameters: ProjectActivitiesApiGetPageOfProjectActivitiesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<ProjectActivity>> {
            return localVarFp.getPageOfProjectActivities(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Project Activity by id/number.
         * @summary Retrieve single Project Activity
         * @param {ProjectActivitiesApiGetProjectActivityByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getProjectActivityById(requestParameters: ProjectActivitiesApiGetProjectActivityByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProjectActivity> {
            return localVarFp.getProjectActivityById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to update a single Project Activity.
         * @summary Update a single Project Activity
         * @param {ProjectActivitiesApiUpdateProjectActivityRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateProjectActivity(requestParameters: ProjectActivitiesApiUpdateProjectActivityRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.updateProjectActivity(requestParameters.projectActivity, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createProjectActivity operation in ProjectActivitiesApi.
 * @export
 * @interface ProjectActivitiesApiCreateProjectActivityRequest
 */
export interface ProjectActivitiesApiCreateProjectActivityRequest {
    /**
     * 
     * @type {ProjectActivity}
     * @memberof ProjectActivitiesApiCreateProjectActivity
     */
    readonly projectActivity?: ProjectActivity
}

/**
 * Request parameters for deleteProjectActivityById operation in ProjectActivitiesApi.
 * @export
 * @interface ProjectActivitiesApiDeleteProjectActivityByIdRequest
 */
export interface ProjectActivitiesApiDeleteProjectActivityByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ProjectActivitiesApiDeleteProjectActivityById
     */
    readonly number: number
}

/**
 * Request parameters for getAllProjectActivities operation in ProjectActivitiesApi.
 * @export
 * @interface ProjectActivitiesApiGetAllProjectActivitiesRequest
 */
export interface ProjectActivitiesApiGetAllProjectActivitiesRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectActivitiesApiGetAllProjectActivities
     */
...
/**
 * Request parameters for getNumberOfProjectActivities operation in ProjectActivitiesApi.
 * @export
 * @interface ProjectActivitiesApiGetNumberOfProjectActivitiesRequest
 */
export interface ProjectActivitiesApiGetNumberOfProjectActivitiesRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectActivitiesApiGetNumberOfProjectActivities
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfProjectActivities operation in ProjectActivitiesApi.
 * @export
 * @interface ProjectActivitiesApiGetPageOfProjectActivitiesRequest
 */
export interface ProjectActivitiesApiGetPageOfProjectActivitiesRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectActivitiesApiGetPageOfProjectActivities
     */
    readonly filter?: string
...
/**
 * Request parameters for getProjectActivityById operation in ProjectActivitiesApi.
 * @export
 * @interface ProjectActivitiesApiGetProjectActivityByIdRequest
 */
export interface ProjectActivitiesApiGetProjectActivityByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ProjectActivitiesApiGetProjectActivityById
     */
    readonly number: number
}

/**
 * Request parameters for updateProjectActivity operation in ProjectActivitiesApi.
 * @export
 * @interface ProjectActivitiesApiUpdateProjectActivityRequest
 */
export interface ProjectActivitiesApiUpdateProjectActivityRequest {
    /**
     * 
     * @type {ProjectActivity}
     * @memberof ProjectActivitiesApiUpdateProjectActivity
     */
    readonly projectActivity?: ProjectActivity
}

/**
 * ProjectActivitiesApi - object-oriented interface
 * @export
 * @class ProjectActivitiesApi
 * @extends {BaseAPI}
 */
export class ProjectActivitiesApi extends BaseAPI {
    /**
     * Use this endpoint to create a single Project Activity.
     * @summary Create a single Project Activity
     * @param {ProjectActivitiesApiCreateProjectActivityRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ProjectActivitiesApi
     */
    public createProjectActivity(requestParameters: ProjectActivitiesApiCreateProjectActivityRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectActivitiesApiFp(this.configuration).createProjectActivity(requestParameters.projectActivity, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectActivitiesApi
     */
    public deleteProjectActivityById(requestParameters: ProjectActivitiesApiDeleteProjectActivityByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectActivitiesApiFp(this.configuration).deleteProjectActivityById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectActivitiesApi
     */
    public getAllProjectActivities(requestParameters: ProjectActivitiesApiGetAllProjectActivitiesRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectActivitiesApiFp(this.configuration).getAllProjectActivities(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectActivitiesApi
     */
    public getNumberOfProjectActivities(requestParameters: ProjectActivitiesApiGetNumberOfProjectActivitiesRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectActivitiesApiFp(this.configuration).getNumberOfProjectActivities(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectActivitiesApi
     */
    public getPageOfProjectActivities(requestParameters: ProjectActivitiesApiGetPageOfProjectActivitiesRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectActivitiesApiFp(this.configuration).getPageOfProjectActivities(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectActivitiesApi
     */
    public getProjectActivityById(requestParameters: ProjectActivitiesApiGetProjectActivityByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectActivitiesApiFp(this.configuration).getProjectActivityById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectActivitiesApi
     */
    public updateProjectActivity(requestParameters: ProjectActivitiesApiUpdateProjectActivityRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectActivitiesApiFp(this.configuration).updateProjectActivity(requestParameters.projectActivity, options).then((request) => request(this.axios, this.basePath));
    }
}
