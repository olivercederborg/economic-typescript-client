...
// @ts-ignore
import type { ProjectStatusCursorResults } from '../model';
/**
...
export const ProjectStatusesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAllProjectStatuses: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/projectstatuses`;
         ...
         * @throws {RequiredError}
         */
        getNumberOfProjectStatuses: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/projectstatuses/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfProjectStatuses: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/projectstatuses/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getProjectStatusById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getProjectStatusById', 'number', number)
            const localVarPath = `/projectstatuses/{number}`
...
export const ProjectStatusesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllProjectStatuses(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectStatusCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllProjectStatuses(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectStatusesApi.getAllProjectStatuses']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getNumberOfProjectStatuses(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfProjectStatuses(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectStatusesApi.getNumberOfProjectStatuses']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Project Statuses.
         ...
         * @throws {RequiredError}
         */
        async getPageOfProjectStatuses(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProjectStatus>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfProjectStatuses(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectStatusesApi.getPageOfProjectStatuses']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Project Status by id/number.
         ...
         * @throws {RequiredError}
         */
        async getProjectStatusById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectStatus>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProjectStatusById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectStatusesApi.getProjectStatusById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const ProjectStatusesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Use this endpoint to retrieve all Project Statuses in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Project Statuses
         * @param {ProjectStatusesApiGetAllProjectStatusesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllProjectStatuses(requestParameters: ProjectStatusesApiGetAllProjectStatusesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ProjectStatusCursorResults> {
            return localVarFp.getAllProjectStatuses(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Project Statuses. You can use a filtering as well.
         * @summary Retrieve the number of Project Statuses
         * @param {ProjectStatusesApiGetNumberOfProjectStatusesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfProjectStatuses(requestParameters: ProjectStatusesApiGetNumberOfProjectStatusesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfProjectStatuses(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Project Statuses.
         * @summary Retrieve a page of Project Statuses
         * @param {ProjectStatusesApiGetPageOfProjectStatusesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfProjectStatuses(requestParameters: ProjectStatusesApiGetPageOfProjectStatusesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<ProjectStatus>> {
            return localVarFp.getPageOfProjectStatuses(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Project Status by id/number.
         * @summary Retrieve single Project Status
         * @param {ProjectStatusesApiGetProjectStatusByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getProjectStatusById(requestParameters: ProjectStatusesApiGetProjectStatusByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProjectStatus> {
            return localVarFp.getProjectStatusById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getAllProjectStatuses operation in ProjectStatusesApi.
 * @export
 * @interface ProjectStatusesApiGetAllProjectStatusesRequest
 */
export interface ProjectStatusesApiGetAllProjectStatusesRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectStatusesApiGetAllProjectStatuses
     */
...
/**
 * Request parameters for getNumberOfProjectStatuses operation in ProjectStatusesApi.
 * @export
 * @interface ProjectStatusesApiGetNumberOfProjectStatusesRequest
 */
export interface ProjectStatusesApiGetNumberOfProjectStatusesRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectStatusesApiGetNumberOfProjectStatuses
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfProjectStatuses operation in ProjectStatusesApi.
 * @export
 * @interface ProjectStatusesApiGetPageOfProjectStatusesRequest
 */
export interface ProjectStatusesApiGetPageOfProjectStatusesRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectStatusesApiGetPageOfProjectStatuses
     */
    readonly filter?: string
...
/**
 * Request parameters for getProjectStatusById operation in ProjectStatusesApi.
 * @export
 * @interface ProjectStatusesApiGetProjectStatusByIdRequest
 */
export interface ProjectStatusesApiGetProjectStatusByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ProjectStatusesApiGetProjectStatusById
     */
...
export class ProjectStatusesApi extends BaseAPI {
     ...
     */
    public getAllProjectStatuses(requestParameters: ProjectStatusesApiGetAllProjectStatusesRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectStatusesApiFp(this.configuration).getAllProjectStatuses(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectStatusesApi
     */
    public getNumberOfProjectStatuses(requestParameters: ProjectStatusesApiGetNumberOfProjectStatusesRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectStatusesApiFp(this.configuration).getNumberOfProjectStatuses(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectStatusesApi
     */
    public getPageOfProjectStatuses(requestParameters: ProjectStatusesApiGetPageOfProjectStatusesRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectStatusesApiFp(this.configuration).getPageOfProjectStatuses(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectStatusesApi
     */
    public getProjectStatusById(requestParameters: ProjectStatusesApiGetProjectStatusByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectStatusesApiFp(this.configuration).getProjectStatusById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
}
