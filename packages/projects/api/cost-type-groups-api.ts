...
// @ts-ignore
import type { CostTypeGroup } from '../model';
// @ts-ignore
import type { CostTypeGroupCursorResults } from '../model';
/**
 * CostTypeGroupsApi - axios parameter creator
 * @export
 */
export const CostTypeGroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getAllCostTypeGroups: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/costtypegroups`;
         ...
         * @throws {RequiredError}
         */
        getCostTypeGroupById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getCostTypeGroupById', 'number', number)
            const localVarPath = `/costtypegroups/{number}`
         ...
         * @throws {RequiredError}
         */
        getNumberOfCostTypeGroups: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/costtypegroups/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfCostTypeGroups: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/costtypegroups/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
/**
 * CostTypeGroupsApi - functional programming interface
 * @export
 */
export const CostTypeGroupsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = CostTypeGroupsApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to retrieve all Cost Type Groups in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Cost Type Groups
         ...
         * @throws {RequiredError}
         */
        async getAllCostTypeGroups(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CostTypeGroupCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllCostTypeGroups(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CostTypeGroupsApi.getAllCostTypeGroups']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getCostTypeGroupById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CostTypeGroup>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCostTypeGroupById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CostTypeGroupsApi.getCostTypeGroupById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Cost Type Groups. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfCostTypeGroups(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfCostTypeGroups(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CostTypeGroupsApi.getNumberOfCostTypeGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Cost Type Groups.
         ...
         * @throws {RequiredError}
         */
        async getPageOfCostTypeGroups(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CostTypeGroup>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfCostTypeGroups(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CostTypeGroupsApi.getPageOfCostTypeGroups']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * CostTypeGroupsApi - factory interface
 * @export
 */
export const CostTypeGroupsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = CostTypeGroupsApiFp(configuration)
    return {
        /**
         * Use this endpoint to retrieve all Cost Type Groups in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Cost Type Groups
         * @param {CostTypeGroupsApiGetAllCostTypeGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllCostTypeGroups(requestParameters: CostTypeGroupsApiGetAllCostTypeGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CostTypeGroupCursorResults> {
            return localVarFp.getAllCostTypeGroups(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Cost Type Group by id/number.
         * @summary Retrieve single Cost Type Group
         * @param {CostTypeGroupsApiGetCostTypeGroupByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getCostTypeGroupById(requestParameters: CostTypeGroupsApiGetCostTypeGroupByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<CostTypeGroup> {
            return localVarFp.getCostTypeGroupById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Cost Type Groups. You can use a filtering as well.
         * @summary Retrieve the number of Cost Type Groups
         * @param {CostTypeGroupsApiGetNumberOfCostTypeGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfCostTypeGroups(requestParameters: CostTypeGroupsApiGetNumberOfCostTypeGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfCostTypeGroups(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Cost Type Groups.
         * @summary Retrieve a page of Cost Type Groups
         * @param {CostTypeGroupsApiGetPageOfCostTypeGroupsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfCostTypeGroups(requestParameters: CostTypeGroupsApiGetPageOfCostTypeGroupsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<CostTypeGroup>> {
            return localVarFp.getPageOfCostTypeGroups(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getAllCostTypeGroups operation in CostTypeGroupsApi.
 * @export
 * @interface CostTypeGroupsApiGetAllCostTypeGroupsRequest
 */
export interface CostTypeGroupsApiGetAllCostTypeGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof CostTypeGroupsApiGetAllCostTypeGroups
     */
...
/**
 * Request parameters for getCostTypeGroupById operation in CostTypeGroupsApi.
 * @export
 * @interface CostTypeGroupsApiGetCostTypeGroupByIdRequest
 */
export interface CostTypeGroupsApiGetCostTypeGroupByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof CostTypeGroupsApiGetCostTypeGroupById
     */
    readonly number: number
}

/**
 * Request parameters for getNumberOfCostTypeGroups operation in CostTypeGroupsApi.
 * @export
 * @interface CostTypeGroupsApiGetNumberOfCostTypeGroupsRequest
 */
export interface CostTypeGroupsApiGetNumberOfCostTypeGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof CostTypeGroupsApiGetNumberOfCostTypeGroups
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfCostTypeGroups operation in CostTypeGroupsApi.
 * @export
 * @interface CostTypeGroupsApiGetPageOfCostTypeGroupsRequest
 */
export interface CostTypeGroupsApiGetPageOfCostTypeGroupsRequest {
    /**
     * 
     * @type {string}
     * @memberof CostTypeGroupsApiGetPageOfCostTypeGroups
     */
    readonly filter?: string
...
/**
 * CostTypeGroupsApi - object-oriented interface
 * @export
 * @class CostTypeGroupsApi
 * @extends {BaseAPI}
 */
export class CostTypeGroupsApi extends BaseAPI {
    /**
     * Use this endpoint to retrieve all Cost Type Groups in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @summary Retrieve all Cost Type Groups
     * @param {CostTypeGroupsApiGetAllCostTypeGroupsRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CostTypeGroupsApi
     */
    public getAllCostTypeGroups(requestParameters: CostTypeGroupsApiGetAllCostTypeGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return CostTypeGroupsApiFp(this.configuration).getAllCostTypeGroups(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CostTypeGroupsApi
     */
    public getCostTypeGroupById(requestParameters: CostTypeGroupsApiGetCostTypeGroupByIdRequest, options?: RawAxiosRequestConfig) {
        return CostTypeGroupsApiFp(this.configuration).getCostTypeGroupById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CostTypeGroupsApi
     */
    public getNumberOfCostTypeGroups(requestParameters: CostTypeGroupsApiGetNumberOfCostTypeGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return CostTypeGroupsApiFp(this.configuration).getNumberOfCostTypeGroups(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CostTypeGroupsApi
     */
    public getPageOfCostTypeGroups(requestParameters: CostTypeGroupsApiGetPageOfCostTypeGroupsRequest = {}, options?: RawAxiosRequestConfig) {
        return CostTypeGroupsApiFp(this.configuration).getPageOfCostTypeGroups(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
}
