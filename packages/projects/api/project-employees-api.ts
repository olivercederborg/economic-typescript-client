...
// @ts-ignore
import type { ProjectEmployee } from '../model';
// @ts-ignore
import type { ProjectEmployeeCursorResults } from '../model';
/**
 * ProjectEmployeesApi - axios parameter creator
 * @export
 */
export const ProjectEmployeesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        createProjectEmployee: async (projectEmployee?: ProjectEmployee, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-employees`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(projectEmployee, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        deleteProjectEmployeeById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('deleteProjectEmployeeById', 'number', number)
            const localVarPath = `/project-employees/{number}`
         ...
         * @throws {RequiredError}
         */
        getAllProjectEmployees: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-employees`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getNumberOfProjectEmployees: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-employees/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfProjectEmployees: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-employees/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getProjectEmployeeById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getProjectEmployeeById', 'number', number)
            const localVarPath = `/project-employees/{number}`
                .replace(`{${"number"}}`, encodeURIComponent(String(number)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        updateProjectEmployee: async (projectEmployee?: ProjectEmployee, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/project-employees`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
/**
 * ProjectEmployeesApi - functional programming interface
 * @export
 */
export const ProjectEmployeesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ProjectEmployeesApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to create a single Project employee.
         * @summary Create a single Project employee
         ...
         * @throws {RequiredError}
         */
        async createProjectEmployee(projectEmployee?: ProjectEmployee, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createProjectEmployee(projectEmployee, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeesApi.createProjectEmployee']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async deleteProjectEmployeeById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteProjectEmployeeById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeesApi.deleteProjectEmployeeById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to retrieve all Project employees in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         ...
         * @throws {RequiredError}
         */
        async getAllProjectEmployees(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectEmployeeCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllProjectEmployees(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeesApi.getAllProjectEmployees']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Project employees. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfProjectEmployees(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfProjectEmployees(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeesApi.getNumberOfProjectEmployees']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Project employees.
         ...
         * @throws {RequiredError}
         */
        async getPageOfProjectEmployees(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProjectEmployee>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfProjectEmployees(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeesApi.getPageOfProjectEmployees']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Project employee by id/number.
         ...
         * @throws {RequiredError}
         */
        async getProjectEmployeeById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectEmployee>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProjectEmployeeById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeesApi.getProjectEmployeeById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to update a single Project employee.
         ...
         * @throws {RequiredError}
         */
        async updateProjectEmployee(projectEmployee?: ProjectEmployee, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateProjectEmployee(projectEmployee, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProjectEmployeesApi.updateProjectEmployee']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * ProjectEmployeesApi - factory interface
 * @export
 */
export const ProjectEmployeesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ProjectEmployeesApiFp(configuration)
    return {
        /**
         * Use this endpoint to create a single Project employee.
         * @summary Create a single Project employee
         * @param {ProjectEmployeesApiCreateProjectEmployeeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createProjectEmployee(requestParameters: ProjectEmployeesApiCreateProjectEmployeeRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CreatedResult> {
            return localVarFp.createProjectEmployee(requestParameters.projectEmployee, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to delete a single Project employee by id/number.
         * @summary Delete single Project employee
         * @param {ProjectEmployeesApiDeleteProjectEmployeeByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteProjectEmployeeById(requestParameters: ProjectEmployeesApiDeleteProjectEmployeeByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteProjectEmployeeById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all Project employees in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Project employees
         * @param {ProjectEmployeesApiGetAllProjectEmployeesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllProjectEmployees(requestParameters: ProjectEmployeesApiGetAllProjectEmployeesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ProjectEmployeeCursorResults> {
            return localVarFp.getAllProjectEmployees(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Project employees. You can use a filtering as well.
         * @summary Retrieve the number of Project employees
         * @param {ProjectEmployeesApiGetNumberOfProjectEmployeesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfProjectEmployees(requestParameters: ProjectEmployeesApiGetNumberOfProjectEmployeesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfProjectEmployees(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Project employees.
         * @summary Retrieve a page of Project employees
         * @param {ProjectEmployeesApiGetPageOfProjectEmployeesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfProjectEmployees(requestParameters: ProjectEmployeesApiGetPageOfProjectEmployeesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<ProjectEmployee>> {
            return localVarFp.getPageOfProjectEmployees(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Project employee by id/number.
         * @summary Retrieve single Project employee
         * @param {ProjectEmployeesApiGetProjectEmployeeByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getProjectEmployeeById(requestParameters: ProjectEmployeesApiGetProjectEmployeeByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<ProjectEmployee> {
            return localVarFp.getProjectEmployeeById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to update a single Project employee.
         * @summary Update a single Project employee
         * @param {ProjectEmployeesApiUpdateProjectEmployeeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateProjectEmployee(requestParameters: ProjectEmployeesApiUpdateProjectEmployeeRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.updateProjectEmployee(requestParameters.projectEmployee, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createProjectEmployee operation in ProjectEmployeesApi.
 * @export
 * @interface ProjectEmployeesApiCreateProjectEmployeeRequest
 */
export interface ProjectEmployeesApiCreateProjectEmployeeRequest {
    /**
     * 
     * @type {ProjectEmployee}
     * @memberof ProjectEmployeesApiCreateProjectEmployee
     */
    readonly projectEmployee?: ProjectEmployee
}

/**
 * Request parameters for deleteProjectEmployeeById operation in ProjectEmployeesApi.
 * @export
 * @interface ProjectEmployeesApiDeleteProjectEmployeeByIdRequest
 */
export interface ProjectEmployeesApiDeleteProjectEmployeeByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ProjectEmployeesApiDeleteProjectEmployeeById
     */
    readonly number: number
}

/**
 * Request parameters for getAllProjectEmployees operation in ProjectEmployeesApi.
 * @export
 * @interface ProjectEmployeesApiGetAllProjectEmployeesRequest
 */
export interface ProjectEmployeesApiGetAllProjectEmployeesRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectEmployeesApiGetAllProjectEmployees
     */
...
/**
 * Request parameters for getNumberOfProjectEmployees operation in ProjectEmployeesApi.
 * @export
 * @interface ProjectEmployeesApiGetNumberOfProjectEmployeesRequest
 */
export interface ProjectEmployeesApiGetNumberOfProjectEmployeesRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectEmployeesApiGetNumberOfProjectEmployees
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfProjectEmployees operation in ProjectEmployeesApi.
 * @export
 * @interface ProjectEmployeesApiGetPageOfProjectEmployeesRequest
 */
export interface ProjectEmployeesApiGetPageOfProjectEmployeesRequest {
    /**
     * 
     * @type {string}
     * @memberof ProjectEmployeesApiGetPageOfProjectEmployees
     */
    readonly filter?: string
...
/**
 * Request parameters for getProjectEmployeeById operation in ProjectEmployeesApi.
 * @export
 * @interface ProjectEmployeesApiGetProjectEmployeeByIdRequest
 */
export interface ProjectEmployeesApiGetProjectEmployeeByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof ProjectEmployeesApiGetProjectEmployeeById
     */
    readonly number: number
}

/**
 * Request parameters for updateProjectEmployee operation in ProjectEmployeesApi.
 * @export
 * @interface ProjectEmployeesApiUpdateProjectEmployeeRequest
 */
export interface ProjectEmployeesApiUpdateProjectEmployeeRequest {
    /**
     * 
     * @type {ProjectEmployee}
     * @memberof ProjectEmployeesApiUpdateProjectEmployee
     */
    readonly projectEmployee?: ProjectEmployee
}

/**
 * ProjectEmployeesApi - object-oriented interface
 * @export
 * @class ProjectEmployeesApi
 * @extends {BaseAPI}
 */
export class ProjectEmployeesApi extends BaseAPI {
    /**
     * Use this endpoint to create a single Project employee.
     * @summary Create a single Project employee
     * @param {ProjectEmployeesApiCreateProjectEmployeeRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ProjectEmployeesApi
     */
    public createProjectEmployee(requestParameters: ProjectEmployeesApiCreateProjectEmployeeRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectEmployeesApiFp(this.configuration).createProjectEmployee(requestParameters.projectEmployee, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeesApi
     */
    public deleteProjectEmployeeById(requestParameters: ProjectEmployeesApiDeleteProjectEmployeeByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectEmployeesApiFp(this.configuration).deleteProjectEmployeeById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeesApi
     */
    public getAllProjectEmployees(requestParameters: ProjectEmployeesApiGetAllProjectEmployeesRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectEmployeesApiFp(this.configuration).getAllProjectEmployees(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeesApi
     */
    public getNumberOfProjectEmployees(requestParameters: ProjectEmployeesApiGetNumberOfProjectEmployeesRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectEmployeesApiFp(this.configuration).getNumberOfProjectEmployees(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeesApi
     */
    public getPageOfProjectEmployees(requestParameters: ProjectEmployeesApiGetPageOfProjectEmployeesRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectEmployeesApiFp(this.configuration).getPageOfProjectEmployees(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeesApi
     */
    public getProjectEmployeeById(requestParameters: ProjectEmployeesApiGetProjectEmployeeByIdRequest, options?: RawAxiosRequestConfig) {
        return ProjectEmployeesApiFp(this.configuration).getProjectEmployeeById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectEmployeesApi
     */
    public updateProjectEmployee(requestParameters: ProjectEmployeesApiUpdateProjectEmployeeRequest = {}, options?: RawAxiosRequestConfig) {
        return ProjectEmployeesApiFp(this.configuration).updateProjectEmployee(requestParameters.projectEmployee, options).then((request) => request(this.axios, this.basePath));
    }
}
