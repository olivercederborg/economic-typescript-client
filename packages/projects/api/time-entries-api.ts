...
// @ts-ignore
import type { TimeEntryCursorResults } from '../model';
// @ts-ignore
import type { TimeEntryNumbersCollection } from '../model';
/**
...
export const TimeEntriesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {TimeEntryNumbersCollection} [timeEntryNumbersCollection] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        approveTimeEntries: async (timeEntryNumbersCollection?: TimeEntryNumbersCollection, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/timeentries/approve`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(timeEntryNumbersCollection, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        approveTimeEntries_1: async (timeEntryNumbersCollection?: TimeEntryNumbersCollection, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/timeentries/approve`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        createTimeEntry: async (timeEntry?: TimeEntry, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        deleteTimeEntryById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('deleteTimeEntryById', 'number', number)
            const localVarPath = `/timeentries/{number}`
         ...
         * @throws {RequiredError}
         */
        getAllTimeEntries: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/timeentries`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getNumberOfTimeEntries: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/timeentries/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPageOfTimeEntries: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/timeentries/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getTimeEntryById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getTimeEntryById', 'number', number)
            const localVarPath = `/timeentries/{number}`
                .replace(`{${"number"}}`, encodeURIComponent(String(number)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        updateTimeEntry: async (timeEntry?: TimeEntry, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/timeentries`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const TimeEntriesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async approveTimeEntries(timeEntryNumbersCollection?: TimeEntryNumbersCollection, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.approveTimeEntries(timeEntryNumbersCollection, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntriesApi.approveTimeEntries']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async approveTimeEntries_1(timeEntryNumbersCollection?: TimeEntryNumbersCollection, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.approveTimeEntries_1(timeEntryNumbersCollection, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntriesApi.approveTimeEntries_1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to create a single Time entry.
         ...
         * @throws {RequiredError}
         */
        async createTimeEntry(timeEntry?: TimeEntry, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createTimeEntry(timeEntry, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntriesApi.createTimeEntry']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to delete a single Time entry by id/number.
         ...
         * @throws {RequiredError}
         */
        async deleteTimeEntryById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteTimeEntryById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntriesApi.deleteTimeEntryById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to retrieve all Time entries in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         ...
         * @throws {RequiredError}
         */
        async getAllTimeEntries(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TimeEntryCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllTimeEntries(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntriesApi.getAllTimeEntries']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Time entries. You can use a filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfTimeEntries(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfTimeEntries(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntriesApi.getNumberOfTimeEntries']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Time entries.
         ...
         * @throws {RequiredError}
         */
        async getPageOfTimeEntries(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TimeEntry>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfTimeEntries(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntriesApi.getPageOfTimeEntries']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single Time entry by id/number.
         ...
         * @throws {RequiredError}
         */
        async getTimeEntryById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TimeEntry>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTimeEntryById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntriesApi.getTimeEntryById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to update a single Time entry.
         ...
         * @throws {RequiredError}
         */
        async updateTimeEntry(timeEntry?: TimeEntry, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateTimeEntry(timeEntry, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TimeEntriesApi.updateTimeEntry']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const TimeEntriesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Use this endpoint to approve a list of Time entries.
         * @summary Approve a list of Time entries
         * @param {TimeEntriesApiApproveTimeEntriesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        approveTimeEntries(requestParameters: TimeEntriesApiApproveTimeEntriesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.approveTimeEntries(requestParameters.timeEntryNumbersCollection, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to approve a list of Time entries.
         * @summary Approve a list of Time entries
         * @param {TimeEntriesApiApproveTimeEntries0Request} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        approveTimeEntries_1(requestParameters: TimeEntriesApiApproveTimeEntries0Request = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.approveTimeEntries_1(requestParameters.timeEntryNumbersCollection, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to create a single Time entry.
         * @summary Create a single Time entry
         * @param {TimeEntriesApiCreateTimeEntryRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createTimeEntry(requestParameters: TimeEntriesApiCreateTimeEntryRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<CreatedResult> {
            return localVarFp.createTimeEntry(requestParameters.timeEntry, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to delete a single Time entry by id/number.
         * @summary Delete single Time entry
         * @param {TimeEntriesApiDeleteTimeEntryByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteTimeEntryById(requestParameters: TimeEntriesApiDeleteTimeEntryByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteTimeEntryById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all Time entries in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Time entries
         * @param {TimeEntriesApiGetAllTimeEntriesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllTimeEntries(requestParameters: TimeEntriesApiGetAllTimeEntriesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<TimeEntryCursorResults> {
            return localVarFp.getAllTimeEntries(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Time entries. You can use a filtering as well.
         * @summary Retrieve the number of Time entries
         * @param {TimeEntriesApiGetNumberOfTimeEntriesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfTimeEntries(requestParameters: TimeEntriesApiGetNumberOfTimeEntriesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfTimeEntries(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Time entries.
         * @summary Retrieve a page of Time entries
         * @param {TimeEntriesApiGetPageOfTimeEntriesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfTimeEntries(requestParameters: TimeEntriesApiGetPageOfTimeEntriesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<TimeEntry>> {
            return localVarFp.getPageOfTimeEntries(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Time entry by id/number.
         * @summary Retrieve single Time entry
         * @param {TimeEntriesApiGetTimeEntryByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getTimeEntryById(requestParameters: TimeEntriesApiGetTimeEntryByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<TimeEntry> {
            return localVarFp.getTimeEntryById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to update a single Time entry.
         * @summary Update a single Time entry
         ...
         * @throws {RequiredError}
         */
        updateTimeEntry(requestParameters: TimeEntriesApiUpdateTimeEntryRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.updateTimeEntry(requestParameters.timeEntry, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for approveTimeEntries operation in TimeEntriesApi.
 * @export
 * @interface TimeEntriesApiApproveTimeEntriesRequest
 */
export interface TimeEntriesApiApproveTimeEntriesRequest {
    /**
     * 
     * @type {TimeEntryNumbersCollection}
     * @memberof TimeEntriesApiApproveTimeEntries
     */
    readonly timeEntryNumbersCollection?: TimeEntryNumbersCollection
}

/**
 * Request parameters for approveTimeEntries_1 operation in TimeEntriesApi.
 * @export
 * @interface TimeEntriesApiApproveTimeEntries0Request
 */
export interface TimeEntriesApiApproveTimeEntries0Request {
    /**
     * 
     * @type {TimeEntryNumbersCollection}
     * @memberof TimeEntriesApiApproveTimeEntries0
     */
    readonly timeEntryNumbersCollection?: TimeEntryNumbersCollection
}

/**
 * Request parameters for createTimeEntry operation in TimeEntriesApi.
 * @export
 * @interface TimeEntriesApiCreateTimeEntryRequest
 */
export interface TimeEntriesApiCreateTimeEntryRequest {
    /**
     * 
     * @type {TimeEntry}
     * @memberof TimeEntriesApiCreateTimeEntry
     */
    readonly timeEntry?: TimeEntry
}

/**
 * Request parameters for deleteTimeEntryById operation in TimeEntriesApi.
 * @export
 * @interface TimeEntriesApiDeleteTimeEntryByIdRequest
 */
export interface TimeEntriesApiDeleteTimeEntryByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof TimeEntriesApiDeleteTimeEntryById
     */
    readonly number: number
}

/**
 * Request parameters for getAllTimeEntries operation in TimeEntriesApi.
 * @export
 * @interface TimeEntriesApiGetAllTimeEntriesRequest
 */
export interface TimeEntriesApiGetAllTimeEntriesRequest {
    /**
     * 
     * @type {string}
     * @memberof TimeEntriesApiGetAllTimeEntries
     */
...
/**
 * Request parameters for getNumberOfTimeEntries operation in TimeEntriesApi.
 * @export
 * @interface TimeEntriesApiGetNumberOfTimeEntriesRequest
 */
export interface TimeEntriesApiGetNumberOfTimeEntriesRequest {
    /**
     * 
     * @type {string}
     * @memberof TimeEntriesApiGetNumberOfTimeEntries
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfTimeEntries operation in TimeEntriesApi.
 * @export
 * @interface TimeEntriesApiGetPageOfTimeEntriesRequest
 */
export interface TimeEntriesApiGetPageOfTimeEntriesRequest {
    /**
     * 
     * @type {string}
     * @memberof TimeEntriesApiGetPageOfTimeEntries
     */
    readonly filter?: string
...
/**
 * Request parameters for getTimeEntryById operation in TimeEntriesApi.
 * @export
 * @interface TimeEntriesApiGetTimeEntryByIdRequest
 */
export interface TimeEntriesApiGetTimeEntryByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof TimeEntriesApiGetTimeEntryById
     */
    readonly number: number
}
...
export class TimeEntriesApi extends BaseAPI {
     ...
     */
    public approveTimeEntries(requestParameters: TimeEntriesApiApproveTimeEntriesRequest = {}, options?: RawAxiosRequestConfig) {
        return TimeEntriesApiFp(this.configuration).approveTimeEntries(requestParameters.timeEntryNumbersCollection, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TimeEntriesApi
     */
    public approveTimeEntries_1(requestParameters: TimeEntriesApiApproveTimeEntries0Request = {}, options?: RawAxiosRequestConfig) {
        return TimeEntriesApiFp(this.configuration).approveTimeEntries_1(requestParameters.timeEntryNumbersCollection, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TimeEntriesApi
     */
    public createTimeEntry(requestParameters: TimeEntriesApiCreateTimeEntryRequest = {}, options?: RawAxiosRequestConfig) {
        return TimeEntriesApiFp(this.configuration).createTimeEntry(requestParameters.timeEntry, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TimeEntriesApi
     */
    public deleteTimeEntryById(requestParameters: TimeEntriesApiDeleteTimeEntryByIdRequest, options?: RawAxiosRequestConfig) {
        return TimeEntriesApiFp(this.configuration).deleteTimeEntryById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TimeEntriesApi
     */
    public getAllTimeEntries(requestParameters: TimeEntriesApiGetAllTimeEntriesRequest = {}, options?: RawAxiosRequestConfig) {
        return TimeEntriesApiFp(this.configuration).getAllTimeEntries(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TimeEntriesApi
     */
    public getNumberOfTimeEntries(requestParameters: TimeEntriesApiGetNumberOfTimeEntriesRequest = {}, options?: RawAxiosRequestConfig) {
        return TimeEntriesApiFp(this.configuration).getNumberOfTimeEntries(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TimeEntriesApi
     */
    public getPageOfTimeEntries(requestParameters: TimeEntriesApiGetPageOfTimeEntriesRequest = {}, options?: RawAxiosRequestConfig) {
        return TimeEntriesApiFp(this.configuration).getPageOfTimeEntries(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TimeEntriesApi
     */
    public getTimeEntryById(requestParameters: TimeEntriesApiGetTimeEntryByIdRequest, options?: RawAxiosRequestConfig) {
        return TimeEntriesApiFp(this.configuration).getTimeEntryById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TimeEntriesApi
     */
    public updateTimeEntry(requestParameters: TimeEntriesApiUpdateTimeEntryRequest = {}, options?: RawAxiosRequestConfig) {
        return TimeEntriesApiFp(this.configuration).updateTimeEntry(requestParameters.timeEntry, options).then((request) => request(this.axios, this.basePath));
    }
}
