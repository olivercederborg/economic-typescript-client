...
// @ts-ignore
import type { MileagePrices } from '../model';
// @ts-ignore
import type { MileagePricesCursorResults } from '../model';
/**
 * MileageEntryPricesApi - axios parameter creator
 * @export
 */
export const MileageEntryPricesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getAllMileageEntryPrices: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mileageprices`;
         ...
         * @throws {RequiredError}
         */
        getMileagePricesById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getMileagePricesById', 'number', number)
            const localVarPath = `/mileageprices/{number}`
         ...
         * @throws {RequiredError}
         */
        getPageOfMileageEntryPrices: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/mileageprices/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
/**
 * MileageEntryPricesApi - functional programming interface
 * @export
 */
export const MileageEntryPricesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = MileageEntryPricesApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to retrieve all Mileage entry prices in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Mileage entry prices
         ...
         * @throws {RequiredError}
         */
        async getAllMileageEntryPrices(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MileagePricesCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllMileageEntryPrices(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntryPricesApi.getAllMileageEntryPrices']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getMileagePricesById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MileagePrices>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMileagePricesById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntryPricesApi.getMileagePricesById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Mileage entry prices.
         ...
         * @throws {RequiredError}
         */
        async getPageOfMileageEntryPrices(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<MileagePrices>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfMileageEntryPrices(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MileageEntryPricesApi.getPageOfMileageEntryPrices']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * MileageEntryPricesApi - factory interface
 * @export
 */
export const MileageEntryPricesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = MileageEntryPricesApiFp(configuration)
    return {
        /**
         * Use this endpoint to retrieve all Mileage entry prices in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
         * @summary Retrieve all Mileage entry prices
         * @param {MileageEntryPricesApiGetAllMileageEntryPricesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllMileageEntryPrices(requestParameters: MileageEntryPricesApiGetAllMileageEntryPricesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<MileagePricesCursorResults> {
            return localVarFp.getAllMileageEntryPrices(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single Mileage entry prices by id/number.
         * @summary Retrieve single Mileage entry prices
         * @param {MileageEntryPricesApiGetMileagePricesByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getMileagePricesById(requestParameters: MileageEntryPricesApiGetMileagePricesByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<MileagePrices> {
            return localVarFp.getMileagePricesById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Mileage entry prices.
         * @summary Retrieve a page of Mileage entry prices
         * @param {MileageEntryPricesApiGetPageOfMileageEntryPricesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfMileageEntryPrices(requestParameters: MileageEntryPricesApiGetPageOfMileageEntryPricesRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<MileagePrices>> {
            return localVarFp.getPageOfMileageEntryPrices(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getAllMileageEntryPrices operation in MileageEntryPricesApi.
 * @export
 * @interface MileageEntryPricesApiGetAllMileageEntryPricesRequest
 */
export interface MileageEntryPricesApiGetAllMileageEntryPricesRequest {
    /**
     * 
     * @type {string}
     * @memberof MileageEntryPricesApiGetAllMileageEntryPrices
     */
...
/**
 * Request parameters for getMileagePricesById operation in MileageEntryPricesApi.
 * @export
 * @interface MileageEntryPricesApiGetMileagePricesByIdRequest
 */
export interface MileageEntryPricesApiGetMileagePricesByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof MileageEntryPricesApiGetMileagePricesById
     */
    readonly number: number
}

/**
 * Request parameters for getPageOfMileageEntryPrices operation in MileageEntryPricesApi.
 * @export
 * @interface MileageEntryPricesApiGetPageOfMileageEntryPricesRequest
 */
export interface MileageEntryPricesApiGetPageOfMileageEntryPricesRequest {
    /**
     * 
     * @type {string}
     * @memberof MileageEntryPricesApiGetPageOfMileageEntryPrices
     */
    readonly filter?: string
...
/**
 * MileageEntryPricesApi - object-oriented interface
 * @export
 * @class MileageEntryPricesApi
 * @extends {BaseAPI}
 */
export class MileageEntryPricesApi extends BaseAPI {
    /**
     * Use this endpoint to retrieve all Mileage entry prices in bulk.  Max number of items returned in a single call is 1000. Use the continuation cursor parameter to set the continuation cursor for retrieval of next set of data. [pagination instructions](#section/Retrieving-data/Pagination)
     * @summary Retrieve all Mileage entry prices
     * @param {MileageEntryPricesApiGetAllMileageEntryPricesRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof MileageEntryPricesApi
     */
    public getAllMileageEntryPrices(requestParameters: MileageEntryPricesApiGetAllMileageEntryPricesRequest = {}, options?: RawAxiosRequestConfig) {
        return MileageEntryPricesApiFp(this.configuration).getAllMileageEntryPrices(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MileageEntryPricesApi
     */
    public getMileagePricesById(requestParameters: MileageEntryPricesApiGetMileagePricesByIdRequest, options?: RawAxiosRequestConfig) {
        return MileageEntryPricesApiFp(this.configuration).getMileagePricesById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MileageEntryPricesApi
     */
    public getPageOfMileageEntryPrices(requestParameters: MileageEntryPricesApiGetPageOfMileageEntryPricesRequest = {}, options?: RawAxiosRequestConfig) {
        return MileageEntryPricesApiFp(this.configuration).getPageOfMileageEntryPrices(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
}
