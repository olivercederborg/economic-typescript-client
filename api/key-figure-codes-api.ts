...
// @ts-ignore
import type { KeyFigureCode } from '../model';
// @ts-ignore
import type { KeyFigureCodeCursorResults } from '../model';
// @ts-ignore
import type { ProblemDetails } from '../model';
/**
 * KeyFigureCodesApi - axios parameter creator
 * @export
 */
export const KeyFigureCodesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Use this endpoint to retrieve all KeyFigureCodes in bulk. The maximum number of items returned in a single call is 1000. Use the continuation cursor parameter to set the cursor for retrieval of the next set of data.<br/>Please check the [pagination instructions](#section/Retrieving-data/Pagination).
         * @summary Retrieve all KeyFigureCodes
         * @param {string} [cursor] 
         * @param {string} [filter] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllKeyFigureCode: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/keyfigurecodes`;
         ...
         * @summary Retrieve single KeyFigureCode
         * @param {number} number 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getKeyFigureCodeById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getKeyFigureCodeById', 'number', number)
            const localVarPath = `/keyfigurecodes/{number}`
         ...
         * @summary Retrieve the number of KeyFigureCodes
         * @param {string} [filter] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfKeyFigureCode: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/keyfigurecodes/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @summary Retrieve a page of KeyFigureCodes
         * @param {string} [filter] 
         * @param {string} [sort] 
         ...
         * @throws {RequiredError}
         */
        getPageOfKeyFigureCode: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/keyfigurecodes/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
/**
 * KeyFigureCodesApi - functional programming interface
 * @export
 */
export const KeyFigureCodesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = KeyFigureCodesApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to retrieve all KeyFigureCodes in bulk. The maximum number of items returned in a single call is 1000. Use the continuation cursor parameter to set the cursor for retrieval of the next set of data.<br/>Please check the [pagination instructions](#section/Retrieving-data/Pagination).
         * @summary Retrieve all KeyFigureCodes
         ...
         * @throws {RequiredError}
         */
        async getAllKeyFigureCode(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<KeyFigureCodeCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllKeyFigureCode(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['KeyFigureCodesApi.getAllKeyFigureCode']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getKeyFigureCodeById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<KeyFigureCode>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getKeyFigureCodeById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['KeyFigureCodesApi.getKeyFigureCodeById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of KeyFigureCodes. You can use filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfKeyFigureCode(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfKeyFigureCode(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['KeyFigureCodesApi.getNumberOfKeyFigureCode']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of KeyFigureCodes.
         ...
         * @throws {RequiredError}
         */
        async getPageOfKeyFigureCode(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<KeyFigureCode>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfKeyFigureCode(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['KeyFigureCodesApi.getPageOfKeyFigureCode']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * KeyFigureCodesApi - factory interface
 * @export
 */
export const KeyFigureCodesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = KeyFigureCodesApiFp(configuration)
    return {
        /**
         * Use this endpoint to retrieve all KeyFigureCodes in bulk. The maximum number of items returned in a single call is 1000. Use the continuation cursor parameter to set the cursor for retrieval of the next set of data.<br/>Please check the [pagination instructions](#section/Retrieving-data/Pagination).
         * @summary Retrieve all KeyFigureCodes
         * @param {KeyFigureCodesApiGetAllKeyFigureCodeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllKeyFigureCode(requestParameters: KeyFigureCodesApiGetAllKeyFigureCodeRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<KeyFigureCodeCursorResults> {
            return localVarFp.getAllKeyFigureCode(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single KeyFigureCode by number.
         * @summary Retrieve single KeyFigureCode
         * @param {KeyFigureCodesApiGetKeyFigureCodeByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getKeyFigureCodeById(requestParameters: KeyFigureCodesApiGetKeyFigureCodeByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<KeyFigureCode> {
            return localVarFp.getKeyFigureCodeById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of KeyFigureCodes. You can use filtering as well.
         * @summary Retrieve the number of KeyFigureCodes
         * @param {KeyFigureCodesApiGetNumberOfKeyFigureCodeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfKeyFigureCode(requestParameters: KeyFigureCodesApiGetNumberOfKeyFigureCodeRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfKeyFigureCode(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of KeyFigureCodes.
         * @summary Retrieve a page of KeyFigureCodes
         * @param {KeyFigureCodesApiGetPageOfKeyFigureCodeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfKeyFigureCode(requestParameters: KeyFigureCodesApiGetPageOfKeyFigureCodeRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<KeyFigureCode>> {
            return localVarFp.getPageOfKeyFigureCode(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getAllKeyFigureCode operation in KeyFigureCodesApi.
 * @export
 * @interface KeyFigureCodesApiGetAllKeyFigureCodeRequest
 */
export interface KeyFigureCodesApiGetAllKeyFigureCodeRequest {
    /**
     * 
     * @type {string}
     * @memberof KeyFigureCodesApiGetAllKeyFigureCode
     */
...
/**
 * Request parameters for getKeyFigureCodeById operation in KeyFigureCodesApi.
 * @export
 * @interface KeyFigureCodesApiGetKeyFigureCodeByIdRequest
 */
export interface KeyFigureCodesApiGetKeyFigureCodeByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof KeyFigureCodesApiGetKeyFigureCodeById
     */
    readonly number: number
}

/**
 * Request parameters for getNumberOfKeyFigureCode operation in KeyFigureCodesApi.
 * @export
 * @interface KeyFigureCodesApiGetNumberOfKeyFigureCodeRequest
 */
export interface KeyFigureCodesApiGetNumberOfKeyFigureCodeRequest {
    /**
     * 
     * @type {string}
     * @memberof KeyFigureCodesApiGetNumberOfKeyFigureCode
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfKeyFigureCode operation in KeyFigureCodesApi.
 * @export
 * @interface KeyFigureCodesApiGetPageOfKeyFigureCodeRequest
 */
export interface KeyFigureCodesApiGetPageOfKeyFigureCodeRequest {
    /**
     * 
     * @type {string}
     * @memberof KeyFigureCodesApiGetPageOfKeyFigureCode
     */
    readonly filter?: string
...
/**
 * KeyFigureCodesApi - object-oriented interface
 * @export
 * @class KeyFigureCodesApi
 * @extends {BaseAPI}
 */
export class KeyFigureCodesApi extends BaseAPI {
    /**
     * Use this endpoint to retrieve all KeyFigureCodes in bulk. The maximum number of items returned in a single call is 1000. Use the continuation cursor parameter to set the cursor for retrieval of the next set of data.<br/>Please check the [pagination instructions](#section/Retrieving-data/Pagination).
     * @summary Retrieve all KeyFigureCodes
     * @param {KeyFigureCodesApiGetAllKeyFigureCodeRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof KeyFigureCodesApi
     */
    public getAllKeyFigureCode(requestParameters: KeyFigureCodesApiGetAllKeyFigureCodeRequest = {}, options?: RawAxiosRequestConfig) {
        return KeyFigureCodesApiFp(this.configuration).getAllKeyFigureCode(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof KeyFigureCodesApi
     */
    public getKeyFigureCodeById(requestParameters: KeyFigureCodesApiGetKeyFigureCodeByIdRequest, options?: RawAxiosRequestConfig) {
        return KeyFigureCodesApiFp(this.configuration).getKeyFigureCodeById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof KeyFigureCodesApi
     */
    public getNumberOfKeyFigureCode(requestParameters: KeyFigureCodesApiGetNumberOfKeyFigureCodeRequest = {}, options?: RawAxiosRequestConfig) {
        return KeyFigureCodesApiFp(this.configuration).getNumberOfKeyFigureCode(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof KeyFigureCodesApi
     */
    public getPageOfKeyFigureCode(requestParameters: KeyFigureCodesApiGetPageOfKeyFigureCodeRequest = {}, options?: RawAxiosRequestConfig) {
        return KeyFigureCodesApiFp(this.configuration).getPageOfKeyFigureCode(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
}
